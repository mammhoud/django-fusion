...
```
Local Machine:    /root/site/websites/applications/proxy/traefik/certs/
...
ls -l /root/site/websites/applications/proxy/traefik/certs/
...
echo -e "\n=== Certificate Files ==="
ls -lh /root/site/websites/applications/proxy/traefik/certs/*.crt
...
cd /root/site/websites/applications/proxy/traefik/certs/
tar -czf ../certs/certs-backup-$(date +%s).tar.gz *.crt *.key
...
```bash
openssl x509 -in /root/site/websites/applications/proxy/traefik/certs/ctc-research.crt -text -noout
```
...
4. **Backup Location** - Backups stored in certs/ directory
