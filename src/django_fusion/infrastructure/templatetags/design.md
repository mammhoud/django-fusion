# Design: Infrastructure Templatetags

## Overview

Template tags module for django_fusion.

## Directory

Path: `django_fusion/infrastructure/templatetags`
...
```mermaid
flowchart LR
    Request --> infrastructure.templatetags
...
```python
from django_fusion.infrastructure.templatetags import example_function
