"""
Base classes and utilities for django_fusion debug tools.

This module provides base classes and utility functions for managing
development tools like Django Debug Toolbar, Silk, and Livereload.

Classes:
    BaseSetup: Base class with common utilities for debug tools.
    DevelopmentTool: Base class for individual development tools.
    DebugToolbar: Debug Toolbar specific implementation.
    Silk: Silk specific implementation.
    Livereload: Livereload specific implementation.

Functions:
    is_debug_mode: Check if DEBUG mode is enabled.
    is_testing: Check if running tests.
    show_toolbar: Centralized switch for Django Debug Toolbar.
    enable_silk: Centralized switch for Django Silk.
