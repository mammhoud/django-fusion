...
MCP_DESIGNER_TOOLS = {
    "designer.website_audit": {
        ...
        "inputSchema": {
            ...
            "properties": {
                "project": {"type": "string", "minLength": 1, "description": "Project identifier (e.g. landing-fusion, precis, formint, or any project name). Must be a non-empty string."},
