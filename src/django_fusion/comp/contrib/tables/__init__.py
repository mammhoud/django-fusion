"""
django_fusion.comp.contrib.tables — Table integration with RowGenerator.
...
from django_fusion.comp.contrib.tables.mixins import TableMixin
from django_fusion.comp.contrib.tables.row_generator import RowGenerator
