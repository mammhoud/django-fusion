"""HTMX request detection, request wrapper, SSE, and response helpers."""
...
def is_htmx_request(request: HttpRequest) -> bool:
    ...
    This is the canonical HTMX check used throughout django-fusion.
    """
...
class SSEMixin:
    ...
    def sse_response(self, event: str, data: dict):
