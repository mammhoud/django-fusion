...
* HTMX detection delegates to ``django_fusion.site._context_mixins.is_htmx_request``.
...
from django_fusion.site._context_mixins import is_htmx_request, is_fragment_request
