...
"""
Base routing classes and utilities for django-fusion.
...
from django_fusion.contrib import (
    DEFAULT,
    camel_case_to_underscore,
    list_path_components,
    strip_suffixes,
)
from django_fusion.site.interface.utils import viewprop
...
class Viewset(BaseViewset, metaclass=ViewsetMeta):
    ...
    def _get_urls(self) -> list[URLPattern | URLResolver]:
        ...
        from .components import RoutableComponent
