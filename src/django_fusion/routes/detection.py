...
The module delegates to `django_fusion.site.interface._context_mixins.is_htmx_request`
for HTMX detection and checks ``X-Up-Version`` for Unpoly requests.
"""
...
from django_fusion.site.interface._context_mixins import is_htmx_request as _is_htmx
...
class FragmentDetector:
    ...
    def is_fragment_request(self, request: HttpRequest) -> bool:
        ...
        return _is_htmx(request) or is_unpoly_request(request)
