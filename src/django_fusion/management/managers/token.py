...
Canonical imports::
    from django_fusion.management.managers.token import TokenAwareManagerMixin
    from django_fusion.management.managers.token import TokenCachedManager
"""
...
class TokenAwareManagerMixin:
    ...
    Canonical import: from django_fusion.management.managers.token import TokenAwareManagerMixin
    """
...
class TokenCachedManager(TokenAwareManagerMixin, CachedManager):
    ...
    Canonical import: from django_fusion.management.managers.token import TokenCachedManager
    """
