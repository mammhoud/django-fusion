"""
Tag managers for person tagging system.

Canonical imports::
    from django_fusion.management.managers.tags import PersonTagCategoryManager
    from django_fusion.management.managers.tags import PersonTagManager
    from django_fusion.management.managers.tags import TaggedPersonManager
"""
...
class PersonTagCategoryManager(CachedManager):
    ...
    Canonical import: from django_fusion.management.managers.tags import PersonTagCategoryManager
    """
...
class PersonTagManager(CachedManager):
    ...
    Canonical import: from django_fusion.management.managers.tags import PersonTagManager
    """
...
class TaggedPersonManager(models.Manager):
    ...
    Canonical import: from django_fusion.management.managers.tags import TaggedPersonManager
    """
