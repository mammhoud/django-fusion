...
SITE_SPECS = (
    ...
    SiteSmokeSpec(
        ...
        public_templates=(
            "www/projects/templates/home/main.html",
            "www/projects/templates/about/main.html",
            "www/projects/templates/services/main.html",
        ...
        component_templates=(
            "www/projects/templates/home/sections/slider.html",
            "plugins/templates/learning/_course_card.html",
            "plugins/templates/products/sections/_product.html",
            "www/projects/templates/services/sections/_testimonial.html",
        ),
    ),
    SiteSmokeSpec(
        key="vresume",
...
def test_base_layout_includes_navigation_footer_metadata_and_assets(
    ...
    if "<html" not in base_source:
        base_source += (APPS_ROOT / "ctc-research" / "templates" / "base.html").read_text(
            encoding="utf-8"
        )
...
def test_base_template_exposes_cross_site_layout_blocks_and_bundles() -> None:
    """Verify base.html (now per-site) contains required layout blocks and bundles."""
    shared_base = APPS_ROOT / "ctc-research" / "templates" / "base.html"
