...
#### A2: Fix lms-demo service names
File: `lms-demo/docker-compose.yml`
...
cp -r lms-demo/assets/templates/generic/* "$TEMP_DIR/" 2>/dev/null || true
...
rm -rf lms-demo/assets/static/js/old_*
...
- `lms-demo/docker-compose.yml` (UPDATE labels)
