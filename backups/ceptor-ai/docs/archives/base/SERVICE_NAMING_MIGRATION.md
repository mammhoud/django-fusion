...
lms-demo-tasks-worker       → lms-worker
worker-lms-demo             → (removed, use lms-worker)
...
lms-demo-tasks-beat         → lms-scheduler
...
**File:** `/root/site/websites/lms-demo/docker-compose.yml`
- ✅ web-lms-demo → lms-web
- ✅ lms-demo-worker → lms-worker
- ✅ Updated dependencies and environment vars
...
6. ✅ `/root/site/websites/lms-demo/docker-compose.yml`
