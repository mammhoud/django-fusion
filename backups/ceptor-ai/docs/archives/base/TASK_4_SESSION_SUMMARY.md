...
- **File Locations:**
  ...
  - Backups: `/root/site/websites/compose/traefik/certs/`
- **Status:** COMPLETE
...
- `compose/traefik/certs/acme_backup_20260602_180601.json`
- `compose/traefik/certs/acme_backup_20260602_180625.json`
- `compose/traefik/certs/production-certs-20260602-180702.tar.gz`
- `compose/traefik/certs/production-certs-20260602-180715.tar.gz`
- `compose/traefik/certs/20260602_180649_certs/`
...
- **Backup:** Use `certs/` directory for safe storage
...
- [DEPLOYMENT_GUIDE_SSL.md](../../guides/infrastructure/DEPLOYMENT_GUIDE_SSL.md) - SSL deployment guide
- 00_MASTER_INDEX.md - Central documentation hub
