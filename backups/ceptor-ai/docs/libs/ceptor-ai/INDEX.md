> **Related Code**
> * **Domain:** Local library — AI orchestration / prompt registry
> * **Paths:**
>   * `applications/libs/ceptor-ai/src/ceptor_ai/` (package root)
>   * `applications/libs/ceptor-ai/src/ceptor_ai/prompts/` (registry entries)
>   * `applications/tasks/ceptor_ai.py` (in-repo task bridge)
> * **Stack:** Python 3.11+, Django 5.x, stdlib-only schemas
> * **Cross-references:** [`../../architecture/routable_applications.md`](../../reference/architecture/routable_applications.md), per-site `prompts.md` under `websites/<slug>/prompts.md`
