...
The `v1/projects/` directory contains the foundation upon which all other VResume apps are built. It provides abstract base classes, shared components, and utility functions.
