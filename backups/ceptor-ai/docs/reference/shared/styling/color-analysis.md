...
Based on analysis of `structa.cloud/projects/assets/static/styles/colors/_master.scss`
...
1. `structa.cloud/projects/assets/static/styles/layout/_sections.scss` - Layout sections with shadow and gradient variables
2. `structa.cloud/projects/assets/static/styles/layout/_listing.scss` - Course cards and featured courses
3. Various component files under `structa.cloud/projects/assets/static/styles/components/` that use color variables
