...
- **Packages**
  ...
  - [crafts-ai](libs/ceptor-ai/legacy-ceptor-ai/)
  - [django-fusion](packages/django-fusion/)
- **Infrastructure**
...
const aliases = {
  ...
  "@htmx":     "assets/static/js/projects/htmx-bridge.js",
