...
│
├── projects/                      # Core application files
...
### Consolidation
- ✅ Merged `init.config.js` into `projects/config.js`
...
- ✅ Standardized naming: `sidebar.init.js` → `projects/sidebar.js`
- ✅ Consistent file naming across all components

### Reorganization
- ✅ Core files → `projects/` directory
...
### After
```javascript
import { CONFIG } from './projects/config.js';
import { app } from './projects/app.js';
import { SidebarComponent } from './components/projects/sidebar.js';
