...
| [CORE_DIRECTORY_REMOVAL_REPORT.md](../archives/structa.cloud_CORE_DIRECTORY_REMOVAL_REPORT.md) | Core directory removal report and migration details |
| [MIGRATION_VERIFICATION_REPORT.md](../archives/structa.cloud_MIGRATION_VERIFICATION_REPORT.md) | Migration verification report |
...
- [Ecosystem Overview](../guides/development/ecosystem)
- [Packages](../libs/)
- [Shared Resources](../reference/shared)
