...
- `.kilo/mcp_server.py`
- `.kilo/skills/`
- `applications/lms-demo/assets/static/styles/`
...
- Shared components are promoted to `applications/assets/templates`; LMS-specific presentation remains in `applications/lms-demo`.

## Validation commands
- `rg -n "id=|class=|include|extends" applications/lms-demo/templates applications/lms-demo/plugins applications/assets/templates`
