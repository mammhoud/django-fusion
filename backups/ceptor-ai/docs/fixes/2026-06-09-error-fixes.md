...
**Root cause:** `www/projects/handlers/models/__init__.py` contained wildcard imports
for `forms` and `snippets` sub-modules that do not exist in either project.

**Fix:**  
`lms-demo/www/projects/handlers/models/__init__.py`  
`ctc-research/www/projects/handlers/models/__init__.py`
...
**Fix:**  
`lms-demo/www/projects/handlers/models/manage/company.py`  
`ctc-research/www/projects/handlers/models/manage/company.py`
...
| `ctc-research/www/projects/handlers/models/__init__.py` | Removed missing imports |
| `ctc-research/www/projects/handlers/models/manage/company.py` | `@register_snippet` on `Organization` |
| `ctc-research/Makefile` | Fixed `webpack-validate` path |
| `lms-demo/www/projects/handlers/models/__init__.py` | Removed missing `forms` import |
| `lms-demo/www/projects/handlers/models/manage/company.py` | `@register_snippet` on `Organization` |
