...
1. Centralize all scattered `.md` specification files into a structured `projects/docs/` directory.
...
│
├── architecture/
│   ├── overview.md                  # Migrated from: projects/CI/README.md
...
#### [NEW] `projects/docs/config/settings.md`
...
#### [NEW] `projects/docs/frontend/allauth-templates.md`
...
|---|---|
| `apps/blog/PRODUCT.md` | `projects/docs/apps/blog.md` |
| `apps/handlers/MCP.md` | `projects/docs/integrations/mcp.md` |
| `apps/handlers/PRODUCT.md` | `projects/docs/apps/handlers.md` |
| `apps/pages/models/contact_analysis.md` | `projects/docs/apps/contact-model.md` |
| `assets/static/js/ARCHITECTURE.md` | `projects/docs/frontend/js-architecture.md` |
| `assets/static/js/README.md` | `projects/docs/frontend/js-codebase.md` |
| `assets/static/js/pages/README.md` | `projects/docs/frontend/pages-layout.md` |
| `assets/static/js/modules/components/docs/preloader.md` | `projects/docs/frontend/preloader.md` |
| `assets/templates/allauth.md` | `projects/docs/frontend/allauth-templates.md` (upgraded) |
| `components/profile/partials/BANNER_OPTIONS.md` | `projects/docs/apps/profile-banner.md` |
| `projects/CI/README.md` | `projects/docs/architecture/temporal-workflows.md` |
| `webpack/readme.md` | `projects/docs/frontend/webpack.md` |
...
**Delete entirely:**
- `projects/CI/models/.md` — empty file (0 bytes)
- `configs/settings/readme.md` — empty, replaced by `projects/docs/config/settings.md`
...
> [!NOTE]
> **Q3:** Should `CHANGELOG.md` or `CONTRIBUTING.md` be created in `projects/docs/` as well?
...
find projects/docs -name "*.md" | sort

# Confirm zero Xellent references remain in docs
grep -r "Xellent\|xellent\|Alliance\|/root/xellent" projects/docs
...
### Manual Review
- Review `projects/docs/README.md` index links for correctness
- Review `projects/docs/INSTALL.md` for accuracy against actual project setup
