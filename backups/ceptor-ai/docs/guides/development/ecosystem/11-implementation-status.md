...
### Model Structure
**Location**: `/root/site/ctc-research/projects/CI/models/cart.py`
...
### Service Layer
**Location**: `/root/site/ctc-research/projects/CI/services/cart_service.py`
...
**Location**: `/root/site/ctc-research/projects/CI/workflows/email.py`
...
**Location**: `/root/site/ctc-research/projects/CI/workflows/activities.py`
...
### Base Modal Template
**Location**: `/root/site/ctc-research/projects/templates/base_modal.html`
...
### Modal Variants
**Locations**:
- `/root/site/ctc-research/projects/templates/base_modal.html` - Base template
...
**Management Command**: `/root/site/ctc-research/projects/CI/management/commands/run_temporal_worker.py`
