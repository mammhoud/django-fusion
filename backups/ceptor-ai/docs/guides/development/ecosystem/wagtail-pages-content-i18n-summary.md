...
**Model:** `www/projects/content/models/pages/home.py`
...
**Model:** `www/projects/content/models/pages/about.py`
...
**Model:** `www/projects/content/models/pages/contact.py`
...
**Model:** `www/projects/content/models/pages/services.py`
...
**Model:** `www/projects/content/models/pages/team.py`
**Type:** Index page (inherits `BaseIndexPage`)
...
**Model:** `www/projects/content/models/pages/event.py`
...
Form submissions are stored in `ContactSubmission` (model in `www/projects/content/models/contact.py`) with: form ID, page ID/title/URL, submitted JSON data, file data, IP address, user agent, referrer, processed flag, and internal notes.
...
- [Architecture Overview](../../../reference/architecture/ecosystem/01_system_overview.md)
- [ctc-research.com Product Docs](../../../ctc-research.com/PRODUCT.md)
- [structa.cloud README](../../../README.md)
