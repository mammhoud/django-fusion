...
Module: apps.accounts.adapters (structa.cloud)

This adapter:
- Maps allauth template names to account/ fragment templates
...
class AuthHTMXAdapter(DefaultAccountAdapter):
    ...
    - Maps allauth view names to account/ fragment templates
    - Wraps fragments in layout/auth/skeleton.html for non-HTMX requests
    ...
    TEMPLATE_MAP: dict[str, str] = {
        "account/signup.html": "account/register.html",
        "account/password_reset.html": "account/forgot_page.html",
        "account/password_reset_from_key.html": "account/reset_password.html",
        "account/password_reset_from_key_done.html": "account/password_reset_key_done.html",
        "account/email_confirm.html": "account/verification_link.html",
        "account/email.html": "account/email_manage.html",
        "socialaccount/signup.html": "account/social_signup.html",
        "socialaccount/connections.html": "account/social_connections.html",
    }
...
class RegistrationAdapter(AuthHTMXAdapter):
    ...
    def send_confirmation_mail(self, request, emailconfirmation, signup):
        ...
        token = registration_token_generator.make_allauth_compatible_token(user, allauth_key)
        ...
        send_registration_email(user, f"{site_url}{confirmation_path}")
