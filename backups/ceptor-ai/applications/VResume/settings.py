...
LOCAL_APPS = [
    # Per-site www/ packages kept site-specific (cookie helpers, celery, middleware)
    "www.core",
...
CELERY_BEAT_SCHEDULE = {
    ...
    "process-scheduled-campaigns": {
        "task": "pages.connect.services.vresume_campaign_tasks.process_scheduled_campaigns",
        "schedule": 300.0,  # Every 5 minutes
        "options": {"queue": "default", "priority": 5},
    },
    "cleanup-old-campaigns": {
        "task": "pages.connect.services.vresume_campaign_tasks.cleanup_old_campaigns",
    ...
    "update-article-engagement-metrics": {
        "task": "pages.blog.services.vresume_analytics_tasks.update_article_engagement_metrics",
        "schedule": crontab(hour="*/4", minute=0),  # Every 4 hours
        "options": {"queue": "default", "priority": 2},
    },
    "generate-trending-articles": {
        "task": "pages.blog.services.vresume_analytics_tasks.generate_trending_articles",
        "schedule": crontab(hour=0, minute=0),  # Daily at midnight UTC
        "options": {"queue": "default", "priority": 2},
        "kwargs": {"days": 7, "limit": 10},
    },
    "cleanup-old-article-reads": {
        "task": "pages.blog.services.vresume_analytics_tasks.cleanup_old_article_reads",
