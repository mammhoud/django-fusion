...
TEMPLATES_DIRS = [
    ...
    BASE_DIR / "assets" / "templates" / "ui",  # shared base templates (base.html, base_auth.html, etc.)
    ...
    BASE_DIR.parent / "assets" / "templates" / "ui",  # workspace-level shared base templates
]
...
# Add unfold templatetags as builtins if installed
if importlib.util.find_spec("unfold") is not None:
    _TEMPLATE_BUILTINS.append("unfold.templatetags.unfold")
