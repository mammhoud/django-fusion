...
## Scope
This directory is an app-specific template root for `applications/ctc-research/www/projects/templates`. Follow the shared template rules in `applications/assets/templates/AGENTS.md` first, then apply these local notes.
