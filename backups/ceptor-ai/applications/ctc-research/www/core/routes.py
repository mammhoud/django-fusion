...
Generated URL prefix: /fusion/
  /fusion/lms/dashboard/
  /fusion/lms/courses/list-fragment/   (HTMX only)
  /fusion/blog/posts/list-fragment/    (HTMX only)
  /fusion/blog/posts/create-fragment/  (HTMX only)
"""
