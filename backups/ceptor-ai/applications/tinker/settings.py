"""Website-local Django settings for Tinker (Template Customizer).
...
SECRET_KEY = os.environ.get(
    "TINKER_SECRET_KEY",
    "django-insecure-tinker-dev-change-in-production"
)

# DEBUG Mode
DEBUG = os.environ.get("TINKER_DEBUG", "true").lower() in ("true", "1", "yes", "on")

# ALLOWED_HOSTS
_hosts_env = os.environ.get("TINKER_ALLOWED_HOSTS", "localhost,127.0.0.1,tinker.localhost")
ALLOWED_HOSTS = [h.strip() for h in _hosts_env.split(",")]

# Site Configuration
WEBSITE_NAME = "tinker"
WEBSITE_IDENTIFIER = "tinker"
SITE_ID = 4
...
LOGGING = {
    ...
    "loggers": {
        ...
        "tinker": {"handlers": ["console"], "level": "DEBUG"},
    },
}
...
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "noreply@tinker.local")
...
CEPTOR_AI_AGENTS_DIR = "../../.kilo/agent/"
CEPTOR_AI_MODELS_FILE = "../../.kilo/models.yml"
