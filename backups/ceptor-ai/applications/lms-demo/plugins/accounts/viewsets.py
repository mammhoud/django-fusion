...
Usage::
    ...
    # Register in www/projects/routes.py → Site.viewsets
"""
...
class EventViewset(ModelViewset):
    ...
    Generates:
      GET  /fusion/events/              → list
      GET  /fusion/events/add/          → create form
      GET  /fusion/events/<pk>/detail/  → detail
      GET  /fusion/events/<pk>/change/  → update form
      GET  /fusion/events/<pk>/delete/  → delete confirm
    """
