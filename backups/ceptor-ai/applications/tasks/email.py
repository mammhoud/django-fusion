...
EMAIL_SERVICE_PATHS = [
    # Canonical shared location -- preferred path after the www/ consolidation.
    "applications.www.core.services.email.service.EmailService",
    # Legacy fallbacks (still in place during the migration window; sites
    # that have not yet adopted the shared module will resolve to these).
