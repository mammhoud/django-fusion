...
//     const libraries = {
//         Swiper: () => import('swiper/bundle'),
//         AOS: () => import('aos'),
//         GLightbox: () => import('glightbox'),
//         imagesLoaded: () => import('imagesloaded'),
//         mixitup: () => import('mixitup'),
//         scrollCue: () => import('scrollcue'),
//         waypoints: () => import('waypoints/lib/noframework.waypoints.min.js')
//     };

//     for (const [name, loader] of Object.entries(libraries)) {
//         try {
//             await loader();
//             console.log(`✅ ${name} loaded`);
//         } catch (error) {
//             console.debug(`⚠️ ${name} not loaded (optional)`);
//         }
//     }
// };
