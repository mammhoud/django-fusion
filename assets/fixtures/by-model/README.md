...
```bash
docker exec web-ctc-research python manage.py loaddata \
  assets/fixtures/by-model/wagtailcore/wagtailcore-locale.json \
  assets/fixtures/by-model/wagtailcore/wagtailcore-site.json \
  assets/fixtures/by-model/wagtailcore/wagtailcore-page.json
```
...
```bash
docker exec web-ctc-research python manage.py loaddata \
  assets/fixtures/by-model/wagtailcore/wagtailcore-collection.json
```
...
```bash
docker exec web-ctc-research python manage.py loaddata \
  assets/fixtures/by-model/wagtailcore/*.json
```
