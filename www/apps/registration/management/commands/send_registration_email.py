...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        from www.apps.registration.emails import send_registration_email
        from www.apps.registration.tokens import registration_token_generator
        from www.apps.registration.views import get_site_url
