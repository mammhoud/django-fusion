...
BACKUP_DIR="${TRAEFIK_DIR}/certs-backups"
...
BACKUP_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)/certs-backups"
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
...
Examples:
  ...
  $0 restore /root/site/websites/compose/traefik/certs-backups/20260602_121530_certs
