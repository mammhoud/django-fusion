...
This script scans django-osoul, django-rseal, django-seed (nawaai), and django-grep
...
class DuplicateScanner:
    ...
    def __init__(self, base_path: Path):
        ...
        self.packages = ["django-osoul", "django-rseal", "django-seed", "django-grep"]
    ...
    def determine_canonical_location(self, name: str, symbol_type: str, symbols: List[Symbol]) -> str:
        ...
        # Automation features → django-rseal
        automation_patterns = [
        ...
        for pattern in automation_patterns:
            if pattern.lower() in name.lower():
                for symbol in symbols:
                    if "django-rseal" in symbol.file_path:
                        return symbol.file_path
    ...
    def generate_markdown_report(self, duplicates: List[DuplicateEntry]) -> str:
        ...
        report.append("")
        report.append("This report identifies duplicate code symbols across django-osoul, django-rseal, django-seed (nawaai), and django-grep packages.")
        report.append("")
        ...
        report.append("2. **Automation features** → django-rseal (keep rseal, remove from grep/seed)")
        ...
        report.append("5. **Testing utilities** → django-grep (new purpose, remove old code)")
