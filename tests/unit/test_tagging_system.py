...
Note: These tests require Article/Product example models which have been removed.
They are skipped if the models cannot be imported.
"""
...
try:
    ...
    EXAMPLE_MODELS_AVAILABLE = True
except (ImportError, RuntimeError):
    Article = None
    Product = None
    EXAMPLE_MODELS_AVAILABLE = False
...
pytestmark = pytest.mark.skipif(
    not EXAMPLE_MODELS_AVAILABLE,
    reason="example_tagged_model (Article/Product) not available",
)
