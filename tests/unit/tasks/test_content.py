...
class TestGetUsersCount:
    @patch("plugins.workers.shared_content.import_first")
    @patch("plugins.workers.shared_content.configure_django_for_website")
...
class TestSendUserWelcomeNotification:
    @patch("plugins.workers.shared_content.send_user_welcome_notification_task")
