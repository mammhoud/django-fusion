...
from crafts_ai.content.blocks.content.overview import OverviewBlock
from crafts_ai.communication.email.models.models import EmailTemplate
from crafts_ai.content.models.default import DefaultBase
...
class Newsletter(
    ...
    body = StreamField(
        OverviewBlock(template="crafts_ai/comp/blocks/content/heading_block.html"),
        blank=True,
        use_json_field=True,
