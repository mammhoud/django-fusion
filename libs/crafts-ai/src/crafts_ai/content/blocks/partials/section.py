...
class SectionBlock(BaseBlock):
    ...
    content = blocks.StreamBlock(
        [
            ("heading", AdvancedHeadingBlock(template="components/blocks/content/heading_block.html")),
            ("paragraph", ParagraphBlock()),
            ("image", SimpleImageBlock(template="components/blocks/media/simple_image.html")),
            ("embed", EmbedBlock()),
            ("document", DocumentBlock()),
            ("table", EnhancedTableBlock(template="components/blocks/partials/enhanced_table.html")),
            ("quote", BlockQuote(template="components/blocks/content/block_quote.html")),
            ("html", HTMLBlock()),
            (
                "typed_table",
                TypedTableBlock([
                        ("text", blocks.CharBlock(template="components/blocks/partials/enhanced_table.html")),
