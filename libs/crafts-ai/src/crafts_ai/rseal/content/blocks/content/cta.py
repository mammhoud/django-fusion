...
__all__ = ["ButtonBlock", "BadgeBlock", "CTABlock"]
...
class ButtonBlock(BaseBlock):
    ...
    class Meta:
        icon = "link"
        label = _("Button")
        # template was: components/blocks/button_block.html
...
class BadgeBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "tag"
        label = _("Badge")
        # template was: components/blocks/badge_block.html
...
class CTABlock(BaseBlock):
    ...
    # CONTENT
    # -------------------------------------------------------------------------
    badge = BadgeBlock(required=False,
        label=_("Optional Badge"), template="components/blocks/content/badge_block.html",
    ...
    primary_button = ButtonBlock(required=False,
        label=_("Primary Button"), template="components/blocks/content/button_block.html",
        help_text=_("Main call-to-action button")
    )

    secondary_button = ButtonBlock(required=False,
        label=_("Secondary Button"), template="components/blocks/content/button_block.html",
    ...
    class Meta:
        ...
        # template was: components/blocks/cta_block.html
        group = _("Marketing")
