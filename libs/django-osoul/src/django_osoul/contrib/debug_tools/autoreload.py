"""
Auto-reload configuration for django_osoul.

This module provides utilities for automatically reloading templates
and static files during development. It integrates with livereload
and Django's autoreload system.

Classes:
    AutoreloadSetup: Configuration class for auto-reloading templates and static files.

Functions:
    configure_autoreload: Convenience function to configure auto-reload.

Usage in Django settings::

    from django_osoul.contrib.debug_tools.autoreload import configure_autoreload
