...
## Scope
This directory is a site-specific template root for `applications/lms-demo/assets/templates`. Follow the shared template rules in `applications/assets/templates/AGENTS.md` first, then apply these local notes.
