"""
Local DefaultBase stub for environments where django_rseal is not installed.
Provides the same abstract fields as django_rseal.content.models.default.DefaultBase.
"""
import uuid
...
class DefaultBase(models.Model):
    ...
    and a live flag – mirrors django_rseal.content.models.default.DefaultBase.
    """
