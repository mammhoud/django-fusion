...
## Scope
This directory is an app-specific template root for `applications/lms-demo/www/core/templates`. Follow the shared template rules in `applications/assets/templates/AGENTS.md` first, then apply these local notes.
