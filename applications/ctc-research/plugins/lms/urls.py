...
# Import specific views without importing cart.py which depends on crafts_ai.site
...
# Lazy load crafts_ai payment views to avoid import conflicts
def _get_payment_urls():
    try:
        from crafts_ai.site.payments import (
            CartPayPalInitView,
            CartStripeInitView,
            PayPalInitView,
            StripeInitView,
