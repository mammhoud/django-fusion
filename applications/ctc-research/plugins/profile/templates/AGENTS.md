...
## Scope
This directory is a plugin-specific template root for `applications/ctc-research/plugins/profile/templates`. Follow the shared template rules in `applications/assets/templates/AGENTS.md` first, then apply these local notes.
