...
## Scope
This directory is a site-specific template root for `applications/ctc-research/templates`. Follow the shared template rules in `applications/assets/templates/AGENTS.md` first, then apply these local notes.
