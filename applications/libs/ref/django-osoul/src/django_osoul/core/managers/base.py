...
Canonical imports::
    ...
    from django_osoul.core.managers import CacheSupportMixin
    from django_osoul.core.managers import CachedManager
    from django_osoul.core.managers import UncachedManager
...
class BaseManager(models.Manager):
    ...
    Canonical import: from django_osoul.core.managers import BaseManager
    """
...
class CacheSupportMixin:
    ...
    Canonical import: from django_osoul.core.managers import CacheSupportMixin
    """
...
class CachedManager(CacheSupportMixin, BaseManager):
    ...
    Canonical import: from django_osoul.core.managers import CachedManager
    """
...
class UncachedManager(BaseManager):
    ...
    Canonical import: from django_osoul.core.managers import UncachedManager
    """
