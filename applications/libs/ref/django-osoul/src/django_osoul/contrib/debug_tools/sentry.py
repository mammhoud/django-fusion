"""
Sentry configuration for django_osoul.
...
Functions:
    configure: Configure Sentry error tracking.
    from_settings: Configure Sentry from Django settings.

Usage::

    from django_osoul.contrib.debug_tools.sentry import SentrySetup
