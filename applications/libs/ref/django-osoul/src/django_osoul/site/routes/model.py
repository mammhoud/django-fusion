...
from django_osoul.contrib import DEFAULT, has_object_perm
from django_osoul.contrib import ViewProp as viewprop
from django_osoul.routes.base import Viewset
from django_osoul.site.generic.list import ListModelView
