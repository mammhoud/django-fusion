...
"""
Fragment detection for HTMX requests in django-osoul.
...
The module delegates to the canonical helper `django_osoul.site._context_mixins.is_htmx_request`
...
from django_osoul.site._context_mixins import is_htmx_request as _is_htmx
