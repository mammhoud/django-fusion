...
class EmailQueueManager:
    ...
    def _queue_with_django_q(self, log, recipient, subject, template_name, context):
        ...
        task_id = async_task(
            'django_rseal.tasks.django_q.send_email_task',
            log.id,
            recipient,
            subject,
            template_name,
            context,
            hook='django_rseal.tasks.django_q.email_sent_hook',
            group='email',
    ...
    def _queue_with_celery(self, log, recipient, subject, template_name, context):
        ...
        try:
            from django_rseal.communication.tasks.celery import send_email_task
    ...
    def schedule_periodic_task(
        ...
        Args:
            name: Task name
            func: Function path (e.g., 'django_rseal.tasks.django_q.check_registrations_task')
