...
# These models must be provided by the project via dependency injection or subclassing.
# Import them lazily or override get_queryset() in project-specific subclasses.
BlogTag = None
BlogTagCategory = None
ProfileTag = None
ProfileTagCategory = None
