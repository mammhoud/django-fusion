"""
Consolidated signal handlers for django_rseal.

This module consolidates all signal handlers from the signals package.

Canonical imports::
    from django_rseal.http.signals.handlers import bind_custom_metadata
    from django_rseal.http.signals.handlers import send_user_welcome_notification
"""
