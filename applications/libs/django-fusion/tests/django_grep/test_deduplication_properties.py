...
DEDUPLICATION_MAP: dict[str, str] = {
    "django-fusion/src/django_fusion/utils/text.py": "django_grep.utils.text",
    "django-fusion/src/django_fusion/utils/responses.py": "django_grep.utils.responses",
    "django-fusion/src/django_fusion/utils/datetime_utils.py": "django_grep.utils.datetime_utils",
    "django-fusion/src/django_fusion/models/mixins.py": "django_grep.models.mixins",
