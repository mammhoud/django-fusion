"""Unit tests for ``django_fusion.analyzer.scanner``.
...
class TestScanDepthCap:
    ...
    def test_max_depth_constants_match_between_scanner_and_views(self):
        ...
        """
        from django_fusion.analyzer.scanner import MAX_DEPTH as S
        from django_fusion.analyzer.views import MAX_DEPTH as V
        assert S == V == 10
