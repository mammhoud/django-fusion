...
Canonical imports::
    from django_fusion.core.managers import BaseManager
    from django_fusion.core.managers import CacheSupportMixin
    from django_fusion.core.managers import CachedManager
    from django_fusion.core.managers import UncachedManager
    from django_fusion.core.managers import cached_method
"""
...
class BaseManager(models.Manager):
    ...
    Canonical import: from django_fusion.core.managers import BaseManager
    """
...
class CacheSupportMixin:
    ...
    Canonical import: from django_fusion.core.managers import CacheSupportMixin
    """
...
class CachedManager(CacheSupportMixin, BaseManager):
    ...
    Canonical import: from django_fusion.core.managers import CachedManager
    """
...
class UncachedManager(BaseManager):
    ...
    Canonical import: from django_fusion.core.managers import UncachedManager
    """
