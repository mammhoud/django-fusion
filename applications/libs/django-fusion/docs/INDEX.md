...
Full reference: **[packages.md → CRUD Free Functions](packages.md#crud-free-functions-django_fusioncoreservicescrud)**

## Surface Map

| Surface | Module | Doc |
|---|---|---|
| CRUD free functions | `django_fusion.core.services.crud` | [packages.md](packages.md#crud-free-functions-django_fusioncoreservicescrud) |
| Component system | `django_fusion.comp` | [packages.md](packages.md#component-system) |
| Analyzer | `django_fusion.analyzer` | [packages.md](packages.md#analyzer-django_fusionanalyzer) |
