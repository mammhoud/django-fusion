"""Unit tests for ``django_osoul.analyzer.scanner``.
...
from django_osoul.analyzer.scanner import (
    MAX_DEPTH,
    _matches_filters,
    scan,
)
...
class TestScanDepthCap:
    ...
    def test_max_depth_constants_match_between_scanner_and_views(self):
        ...
        """
        from django_osoul.analyzer.scanner import MAX_DEPTH as S
        from django_osoul.analyzer.views import MAX_DEPTH as V
        assert S == V == 10
