"""
Network detection and environment utilities for django_osoul.
...
Usage::
    ...
    from django_osoul.contrib.debug_tools.detection import get_internal_ips, get_environment_info
"""
