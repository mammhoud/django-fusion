"""
Base management command classes for django-osoul.
...
class BaseCommand(DjangoBaseCommand):
    ...
    Usage:
        from django_osoul.management.base import BaseCommand
...
class LoggingCommand(BaseCommand):
    ...
    Usage:
        from django_osoul.management.base import LoggingCommand
