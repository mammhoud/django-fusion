...
Canonical imports::
    from django_osoul.core.managers import PersonTagCategoryManager
    from django_osoul.core.managers import PersonTagManager
    from django_osoul.core.managers import TaggedPersonManager
"""
...
class PersonTagCategoryManager(CachedManager):
    ...
    Canonical import: from django_osoul.core.managers import PersonTagCategoryManager
    """
...
class PersonTagManager(CachedManager):
    ...
    Canonical import: from django_osoul.core.managers import PersonTagManager
    """
...
class TaggedPersonManager(models.Manager):
    ...
    Canonical import: from django_osoul.core.managers import TaggedPersonManager
    """
