...
@register.inclusion_tag(
    "routable_components/menu/site_menu.html",
    takes_context=True,
)
def site_menu(context: dict[str, Any], site: Any, user: Any) -> dict[str, Any]:
    ...
    Template: ``routable_components/menu/site_menu.html``
    """
    apps = []
...
@register.inclusion_tag(
    "routable_components/menu/app_menu.html",
    takes_context=True,
)
def app_menu(context: dict[str, Any], app: Any, user: Any) -> dict[str, Any]:
    ...
    Template: ``routable_components/menu/app_menu.html``
    """
    items = []
...
@register.inclusion_tag("routable_components/breadcrumbs.html")
def breadcrumbs(component: Any) -> dict[str, Any]:
    ...
    Template: ``routable_components/breadcrumbs.html``
    """
    crumbs = []
...
@register.inclusion_tag("routable_components/pagination.html")
def fragment_pagination(page_obj: Any, url: str = "") -> dict[str, Any]:
    """
    Render HTMX-aware pagination controls.

    Usage::

        {% fragment_pagination page_obj url=request.path %}

    Template: ``routable_components/pagination.html``
    """
    return {
        "page_obj": page_obj,
