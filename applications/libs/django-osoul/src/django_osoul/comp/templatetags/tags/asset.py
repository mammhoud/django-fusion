...
from django_osoul.comp.configuration.manifest import load_asset_manifest, normalize_path
...
def do_asset(_parser: Parser, token: Token) -> AssetNode:
    ...
    if len(bits) < 1:
        msg = "block:assets tag requires at least one argument"
...
class AssetNode(template.Node):
    ...
    def render(self, context: Context) -> str:
        ...
        from django_osoul.comp.static.staticfiles import Asset, get_component_assets
