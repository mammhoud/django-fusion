"""
AI integrations for ceptorai — pure Python, no Django required.
...
class GeminiIntegration(AIIntegration):
    """
    Google Gemini integration — pure Python, no Django required.

    API key read from ``GEMINI_API_KEY`` env var if not provided.
...
AIIntegrationRegistry.register("gemini", GeminiIntegration)
