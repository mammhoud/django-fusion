...
from ceptor_ai.content.blocks.content.overview import OverviewBlock
from ceptor_ai.communication.email.models.models import EmailTemplate
from ceptor_ai.content.models.default import DefaultBase
...
class Newsletter(
    ...
    body = StreamField(
        OverviewBlock(template="ceptor_ai/comp/blocks/content/heading_block.html"),
        blank=True,
        use_json_field=True,
