...
from ceptor_ai.services.email_service import EmailService
from ceptor_ai.services.invitation_service import InvitationService
from ceptor_ai.services.queue_manager import EmailQueueManager
from ceptor_ai.services.report_generator import ReportGenerator
...
def setup_periodic_tasks():
    ...
    manager.schedule_periodic_task(
        ...
        func='ceptor_ai.tasks.django_q.check_registrations_task',
        schedule_type='D',
        repeats=-1,
    )
    ...
    manager.schedule_periodic_task(
        ...
        func='ceptor_ai.tasks.django_q.generate_weekly_report_task',
        schedule_type='W',
        repeats=-1,
    )
