"""Utilities for planning ceptor-ai import migration work."""
...
class MigrationItem:
    """One discovered ceptor-ai import and its migration decision."""
