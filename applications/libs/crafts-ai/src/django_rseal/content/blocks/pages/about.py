...
class AboutSectionBlock(BaseBlock):
    ...
    counters = blocks.ListBlock(
        CounterItemBlock(template="components/blocks/pages/enhanced_about_section.html"),
    ...
    team_members = blocks.ListBlock(
        TeamMemberBlock(template="components/blocks/pages/enhanced_team_member.html"),
    ...
    gallery_items = blocks.ListBlock(
        MediaGalleryItemBlock(template="components/blocks/media/media_gallery_item.html"),
    ...
    class Meta:
        ...
        # template was: blocks/enhanced_about_section.html
        group = _("About")
