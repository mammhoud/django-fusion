...
from django_rseal.content.blocks.content.overview import OverviewBlock
from django_rseal.communication.email.models.models import EmailTemplate
from django_rseal.content.models.default import DefaultBase
...
class Newsletter(
    ...
    body = StreamField(
        OverviewBlock(template="django_rseal/comp/blocks/content/heading_block.html"),
        blank=True,
        use_json_field=True,
