...
1. ``crafts_ai.ai`` (built-in, Django-integrated) — default.
...
Usage::
    ...
    from crafts_ai.communication.newsletter.enhancer import NewsletterEnhancer

    # Default — uses crafts_ai.ai (OpenAI or Claude via Django settings)
...
def _get_ai_registry(backend: str):
    ...
    try:
        ...
        try:
            from crafts_ai.ai.integrations import AIIntegrationRegistry  # noqa: PLC0415
            return AIIntegrationRegistry
        except ImportError:
            logger.warning(
