...
from crafts_ai.apps import DjangoRsealConfig
from crafts_ai.routes.newsletter.subscription import SubscribeView
from crafts_ai.content.site import *
from crafts_ai.content.site.auth.privacy import PrivacyModalView
...
urlpatterns = [
    ...
    path("newsletter/", include("crafts_ai.routes.newsletter.urls", namespace="newsletter")),
    # Chat bubble
    path("chat/", include("crafts_ai.chat.urls", namespace="rseal_chat")),
]
