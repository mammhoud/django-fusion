"""
Consolidated signal handlers for crafts_ai.

This module consolidates all signal handlers from the signals package.

Canonical imports::
    from crafts_ai.http.signals.handlers import bind_custom_metadata
    from crafts_ai.http.signals.handlers import send_user_welcome_notification
"""
