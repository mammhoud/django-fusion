...
class TestRoutableComponent(TestCase):
    ...
    def setUp(self):
        from django_osoul.site.routes import RoutableComponent
...
class TestFragmentDetector(TestCase):
    ...
    def setUp(self):
        from django_osoul.site.routes import FragmentDetector
...
class TestApplicationMenuOrdering(TestCase):
    ...
    def test_menu_items_sorted_by_menu_order(self):
        from django_osoul.site.routes import Application, AppMenuMixin, RoutableComponent
...
class TestSite(TestCase):
    ...
    def setUp(self):
        from django_osoul.site.routes import Application, RoutableComponent, Site
    ...
    def test_site_title_defaults_to_class_name(self):
        from django_osoul.site.routes import Site
...
class TestBaseViewset(TestCase):
    ...
    def test_viewset_parents_empty(self):
        from django_osoul.site.routes import Viewset
...
class TestReadonlyModelViewset(TestCase):
    ...
    def setUp(self):
        from django.db import models
        from django_osoul.site.routes import ReadonlyModelViewset
...
class TestApplicationHasViewPermission(TestCase):
    ...
    def test_application_has_view_permission_with_permission(self):
        from django_osoul.site.routes import Application
...
class TestAppMenuMixin(TestCase):
    ...
    def test_title_defaults_to_class_name(self):
        from django_osoul.site.routes import AppMenuMixin
