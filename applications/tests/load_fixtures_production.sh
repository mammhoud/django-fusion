...
load_fixture "Locales" "$FIXTURES_DIR/wagtailcore/wagtailcore-locale.json"
load_fixture "Site" "$FIXTURES_DIR/wagtailcore/wagtailcore-site.json"
echo "" | tee -a "$LOG_FILE"

# Step 2: Load page models
log "Step 2/5: Loading page models and structure..."
load_fixture "Base Pages" "$FIXTURES_DIR/wagtailcore/wagtailcore-page.json"
load_fixture "Collections" "$FIXTURES_DIR/wagtailcore/wagtailcore-collection.json"
load_fixture "Group Collection Permissions" "$FIXTURES_DIR/wagtailcore/wagtailcore-groupcollectionpermission.json"
load_fixture "Group Page Permissions" "$FIXTURES_DIR/wagtailcore/wagtailcore-grouppagepermission.json"
echo "" | tee -a "$LOG_FILE"
...
load_fixture "Homepage" "$FIXTURES_DIR/wagtailcore/pages-homepage.json"
load_fixture "About Page" "$FIXTURES_DIR/wagtailcore/pages-aboutpage.json"
load_fixture "Contact Page" "$FIXTURES_DIR/wagtailcore/pages-contactpage.json"
load_fixture "Team Page" "$FIXTURES_DIR/wagtailcore/pages-teampage.json"
load_fixture "Courses Page" "$FIXTURES_DIR/wagtailcore/lms-coursespage.json"
echo "" | tee -a "$LOG_FILE"

# Step 5: Load workflows and metadata
log "Step 5/5: Loading workflows, logs, and metadata..."
load_fixture "Workflows" "$FIXTURES_DIR/wagtailcore/wagtailcore-workflow.json"
load_fixture "Workflow Pages" "$FIXTURES_DIR/wagtailcore/wagtailcore-workflowpage.json"
load_fixture "Workflow Tasks" "$FIXTURES_DIR/wagtailcore/wagtailcore-workflowtask.json"
load_fixture "Group Approval Tasks" "$FIXTURES_DIR/wagtailcore/wagtailcore-groupapprovaltask.json"
load_fixture "Tasks" "$FIXTURES_DIR/wagtailcore/wagtailcore-task.json"
load_fixture "Page Log Entries" "$FIXTURES_DIR/wagtailcore/wagtailcore-pagelogentry.json"
load_fixture "Model Log Entries" "$FIXTURES_DIR/wagtailcore/wagtailcore-modellogentry.json"
load_fixture "Revisions" "$FIXTURES_DIR/wagtailcore/wagtailcore-revision.json"
load_fixture "Reference Index" "$FIXTURES_DIR/wagtailcore/wagtailcore-referenceindex.json"
load_fixture "Page Subscriptions" "$FIXTURES_DIR/wagtailcore/wagtailcore-pagesubscription.json"
