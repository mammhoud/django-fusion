<?php
/*
 * FileGator — shared-media proxy configuration (media.structa.cloud/filegator/)
 * =============================================================================
 * Drop-in replacement for the baked /var/www/filegator/configuration.php with
 * production hardening applied:
 *   - randomized csrf_key (baked default "123456" must never ship to prod)
 *   - cookie_secure=true (terminated TLS at Traefik; cookie over HTTPS only)
 *   - timezone UTC, 100MB uploads, JSON-file auth (default admin user)
 *
 * The remaining services mirror the image defaults so no adapter regressions.
 * Docs: https://docs.filegator.io/configuration/
 */
...
return [
    ...
    'frontend_config' => [
        ...
        'upload_max_size' => 100 * 1024 * 1024, // 100MB (nginx client_max_body_size is 128m)
    ...
    'services' => [
            ...
            'config' => [
                'handler' => function () {
                    ...
                    return new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage([
                            "cookie_samesite" => "Lax",
                            "cookie_secure" => true, // behind Traefik TLS
        ...
        'Filegator\Services\Security\Security' => [
            ...
            'config' => [
                ...
                // Randomized — never use the baked "123456" in production.
                'csrf_key' => "Bc7vY2qN9tLmR4sXwZ8aJdKfG1hP0uE6",
                'ip_allowlist' => [],
                'ip_denylist' => [],
