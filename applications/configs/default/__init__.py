"""Shared default settings for Fusion CMS/LMS projects.
...
- Common Fusion settings (layouts, features, assets, apps, templates, CORS)
...
# Worker implementations live in the product's plugins/workers package.
