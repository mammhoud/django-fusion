...
| `GET /viewsets` | Available `django-fusion` viewsets |
| `GET /migrations/status` | Django `showmigrations` output (503 if Django not configured) |
| `GET /ceptor-ai/info` | `ceptor_ai` package metadata |
| `GET /ceptor-ai/agents` | Known `ceptor_ai` agents listing |
| `GET /django-fusion/info` | `django-fusion` package metadata and module inventory |
| `GET /django-fusion/viewsets` | `django-fusion` viewsets availability |
