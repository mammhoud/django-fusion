...
CACHES = {
    "default": {
        ...
        "KEY_PREFIX": f"{tracker.module.lower()}:{tracker.SERVER_ENV.value}",
    ...
    "session": {
        ...
        "KEY_PREFIX": f"{tracker.module.lower()}:session",
    },
}
...
from .celery_beat import CELERY_BEAT_SCHEDULE  # noqa: E402, F401

# -------------------------------
# Cache Timeouts
# -------------------------------
CACHE_MIDDLEWARE_SECONDS = 300  # 5 minutes
CACHE_MIDDLEWARE_KEY_PREFIX = f"{tracker.module.lower()}_middleware"
