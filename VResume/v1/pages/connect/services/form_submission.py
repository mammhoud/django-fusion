...
class FormSubmissionService:
    ...
    def send_notification_email(
        ...
        template_name: str = "connect/emails/form_submission_notification.html",
    ) -> bool:
        """
        ...
        try:
            ...
            # Build email context
            base_url = settings.get("BASE_URL", settings.get("WAGTAILADMIN_BASE_URL", "http://localhost:8000"))
            context = {
                ...
                "admin_url": base_url + reverse("admin:communications_formsubmission_change", args=[submission.pk]),
            }
