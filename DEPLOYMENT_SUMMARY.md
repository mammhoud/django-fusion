...
- **File**: `<website>/settings.py` (ctc-research, lms-demo, VResume)
- **Changes**:
...
- **File**: `<website>/server.py` (ctc-research, lms-demo, VResume)
- **Features**:
...
- **File**: `<website>/__main__.py` (ctc-research, lms-demo, VResume)
...
- `worker-lms-demo`: LMS Demo background worker
...
4. `lms-demo/settings.py` - Unified configuration
5. `lms-demo/server.py` - Unified ASGI/WSGI server
6. `lms-demo/__main__.py` - Entry point
...
15. `lms-demo/docker-compose.yml` - Updated service names and deploy sections
