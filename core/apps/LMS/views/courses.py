...
from django_grep.pipelines.models import CachingStorage
...
class FrontCourseDetail(PageHandler, TemplateView):
    page_title = "Course"
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            ...
            logger.error(f"Error in FrontCourseDetail for slug {slug}: {e}")
...
class FrontCourseDetailFragment(PageHandler, TemplateView):
    page_title = "Course"
...
from .views import CourseSearchView, CourseSearchAPIView, FrontCourseDetail
...
urlpatterns = [
    ...
    path('course/<slug:slug>/', FrontCourseDetail.as_view(), name='course_detail'),
