...
from django_grep.comp.blocks import OverviewBlock
from django_grep.pipelines.models import (
    CachingStorage,  # Assuming you have this module
    DefaultBase,
    ModelCacheMixin,
)
...
class Course(ClusterableModel, index.Indexed, ModelCacheMixin, DefaultBase):
    ...
    def get_course_details(cls, slug: str) -> Dict[str, Any] | None:
        ...
        Called by FrontCourseDetail.get_course_context.
        """
    ...
    def get_course_modules(cls, course: Course) -> Any:
        ...
        """
        from apps.LMS.services.lessons import LessonsService
    ...
    def get_cached_search_results(
        ...
        """
        from apps.LMS.services.courses import CourseService
