...
## Scope
This directory is an app-specific template root for `core/ctc-research/www/core/templates`. Follow the shared template rules in `core/assets/templates/AGENTS.md` first, then apply these local notes.
