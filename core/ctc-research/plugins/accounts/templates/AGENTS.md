...
## Scope
This directory is a plugin-specific template root for `core/ctc-research/plugins/accounts/templates`. Follow the shared template rules in `core/assets/templates/AGENTS.md` first, then apply these local notes.
