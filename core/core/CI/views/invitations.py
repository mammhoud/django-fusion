...
from ..adapters.invitations import get_invitations_adapter
from ..app_settings import app_settings
from ..exceptions.invitation import AlreadyAccepted, AlreadyInvited, UserRegisteredEmail
from ..forms.invitations import CleanEmailMixin
from ..preloads.invitation import get_invitation_model, get_invite_form
from ..signals.invitations import invite_accepted
...
class SendInvite(FormView):
    template_name = "generic/_invite.html"
...
class AcceptInvite(SingleObjectMixin, View):
    ...
    def post(self, *args, **kwargs):
        ...
        if app_settings.GONE_ON_ACCEPT_ERROR and (
            ...
            or (
                invitation
                and (invitation.accepted or invitation.key_expired())
            )
        ):
