...
## Scope
This directory is a site-specific template root for `core/lms-demo/templates`. Follow the shared template rules in `core/assets/templates/AGENTS.md` first, then apply these local notes.
