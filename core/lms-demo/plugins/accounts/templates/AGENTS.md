...
## Scope
This directory is a plugin-specific template root for `applications/lms-demo/plugins/accounts/templates`. Follow the shared template rules in `applications/assets/templates/AGENTS.md` first, then apply these local notes.
