"""Shared content/account utility tasks."""
...
@shared_task(name="shared.content.users_count")
...
@shared_task(
    name="shared.content.welcome_email",
...
def send_user_welcome_notification(user, profile=None) -> None:
    ...
    if hasattr(send_user_welcome_notification_task, "delay"):
        send_user_welcome_notification_task.delay(user.pk)
        return
