...
- `frontend/` — Astro + Alpine.js + HTMX shell (precis-landing skeleton-loading pattern)
...
│   │   ├── fusion.py            # render-mode/nav/assets contract (precis-landing parity)
...
### Fusion render-mode (precis-landing parity)
