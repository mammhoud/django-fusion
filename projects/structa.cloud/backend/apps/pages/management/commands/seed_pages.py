...
DEFAULT_PAGE_TRANSLATIONS = {
    ...
    # ── Product pages ───────────────────────────────────────────────────
    # Partial overlays for the product detail pages (children of the Products
    # page). Following the same partial-overlay contract as the top-level
    # pages: title, tagline, hero and cta are translated; deep technical
    # content (editions feature lists, comparison tables, FAQ answers) keeps
    # the canonical English through the API fallback.
    "formint-pos": {
        "ar": {"title": "فورمينتس", "content": {"tagline": "نظام نقاط بيع لسطح المكتب بأربعة إصدارات: المجتمع، القياسي، المحترف، والسحابي.", "hero": {"title": "فورمينتس", "subtitle": "تطبيق نقاط بيع لسطح المكتب بنواة Tauri 2 + Rust وواجهة React/Vite وتخزين SQLite.", "primary_cta": {"label": "اطّلع على الإصدارات"}, "secondary_cta": {"label": "تصفّح المستودع"}, "trusted_by": "المجتمع · القياسي · المحترف · السحابي"}, "cta": {"title": "شغّل طرفية نقاط بيع خلال دقائق", "subtitle": "انسخ المستودع، شغّل إصدار المجتمع، ورقِّ الإصدار مع نمو عملك.", "primary_cta": {"label": "عرض على GitHub"}, "secondary_cta": {"label": "تواصل معنا"}}}},
        "sv": {"title": "Formints", "content": {"tagline": "Kassasystem för stationära datorer i fyra utgåvor: Community, Standard, Pro och Cloud.", "hero": {"title": "Formints", "subtitle": "Ett kassasystem för stationära datorer med en Tauri 2 + Rust-kärna, React/Vite-gränssnitt och SQLite-lagring.", "primary_cta": {"label": "Se utgåvorna"}, "secondary_cta": {"label": "Visa repot"}, "trusted_by": "Community · Standard · Pro · Cloud"}, "cta": {"title": "Kör en kassa inom minuter", "subtitle": "Klona repot, kör Community och uppgradera utgåva när du växer.", "primary_cta": {"label": "Visa på GitHub"}, "secondary_cta": {"label": "Kontakta oss"}}}},
        "fr": {"title": "Formints", "content": {"tagline": "Caisse enregistreuse de bureau en quatre éditions : Community, Standard, Pro et Cloud.", "hero": {"title": "Formints", "subtitle": "Une caisse de bureau avec un noyau Tauri 2 + Rust, une interface React/Vite et un stockage SQLite.", "primary_cta": {"label": "Voir les éditions"}, "secondary_cta": {"label": "Voir le dépôt"}, "trusted_by": "Community · Standard · Pro · Cloud"}, "cta": {"title": "Une caisse prête en quelques minutes", "subtitle": "Clonez le dépôt, lancez Community et passez à l'édition supérieure au fil de votre croissance.", "primary_cta": {"label": "Voir sur GitHub"}, "secondary_cta": {"label": "Contactez-nous"}}}},
        "de": {"title": "Formints", "content": {"tagline": "Desktop-Kassensystem in vier Editionen: Community, Standard, Pro und Cloud.", "hero": {"title": "Formints", "subtitle": "Ein Desktop-Kassensystem mit Tauri-2-+-Rust-Kern, React/Vite-Oberfläche und SQLite-Speicher.", "primary_cta": {"label": "Editionen ansehen"}, "secondary_cta": {"label": "Repository ansehen"}, "trusted_by": "Community · Standard · Pro · Cloud"}, "cta": {"title": "In Minuten einsatzbereit", "subtitle": "Repository klonen, Community ausführen und mit dem Wachstum upgraden.", "primary_cta": {"label": "Auf GitHub ansehen"}, "secondary_cta": {"label": "Kontakt aufnehmen"}}}},
        "es": {"title": "Formints", "content": {"tagline": "Caja registradora de escritorio en cuatro ediciones: Community, Standard, Pro y Cloud.", "hero": {"title": "Formints", "subtitle": "Una caja registradora de escritorio con núcleo Tauri 2 + Rust, interfaz React/Vite y almacenamiento SQLite.", "primary_cta": {"label": "Ver las ediciones"}, "secondary_cta": {"label": "Ver el repositorio"}, "trusted_by": "Community · Standard · Pro · Cloud"}, "cta": {"title": "Una caja lista en minutos", "subtitle": "Clona el repositorio, ejecuta Community y sube de edición a medida que creces.", "primary_cta": {"label": "Ver en GitHub"}, "secondary_cta": {"label": "Contacte con nosotros"}}}},
        "pt": {"title": "Formints", "content": {"tagline": "Sistema de ponto de venda para desktop em quatro edições: Community, Standard, Pro e Cloud.", "hero": {"title": "Formints", "subtitle": "Um sistema de ponto de venda para desktop com núcleo Tauri 2 + Rust, interface React/Vite e armazenamento SQLite.", "primary_cta": {"label": "Ver as edições"}, "secondary_cta": {"label": "Ver o repositório"}, "trusted_by": "Community · Standard · Pro · Cloud"}, "cta": {"title": "Um terminal pronto em minutos", "subtitle": "Clone o repositório, execute a Community e suba de edição à medida que cresce.", "primary_cta": {"label": "Ver no GitHub"}, "secondary_cta": {"label": "Fale connosco"}}}},
    },
    "lms": {
        "ar": {"title": "بريسيز LMS", "content": {"tagline": "منصة التعلّم خلف structa.cloud: دورات وتسجيل ومدفوعات.", "hero": {"title": "بريسيز LMS", "subtitle": "منصة تعلّم تعتمد على المحتوى، مبنية على Django وdjango-fusion مع واجهة Next.js.", "primary_cta": {"label": "اطّلع على الإصدارات"}, "secondary_cta": {"label": "تعلّم المزيد"}}, "cta": {"title": "علّم على مكدّس AHA", "subtitle": "من دورة واحدة إلى أكاديمية كاملة: محتوى موجّه، مدفوعات مدمجة، وعرض من الخادم.", "primary_cta": {"label": "اطّلع على الأسعار"}, "secondary_cta": {"label": "تواصل معنا"}}}},
        "sv": {"title": "Precis LMS", "content": {"tagline": "Lärplattformen bakom structa.cloud: kurser, registreringar, betalningar.", "hero": {"title": "Precis LMS", "subtitle": "En innehållsdriven lärplattform byggd på Django + django-fusion med en Next.js-frontend.", "primary_cta": {"label": "Se utgåvorna"}, "secondary_cta": {"label": "Läs mer"}}, "cta": {"title": "Undervisa på AHA-stacken", "subtitle": "Från en kurs till en hel akademi: innehållsdrivet, med betalningar och serverrendering.", "primary_cta": {"label": "Se priser"}, "secondary_cta": {"label": "Kontakta oss"}}}},
        "fr": {"title": "Precis LMS", "content": {"tagline": "La plateforme d'apprentissage derrière structa.cloud : cours, inscriptions, paiements.", "hero": {"title": "Precis LMS", "subtitle": "Une plateforme d'apprentissage pilotée par le contenu, bâtie sur Django + django-fusion avec un frontend Next.js.", "primary_cta": {"label": "Voir les éditions"}, "secondary_cta": {"label": "En savoir plus"}}, "cta": {"title": "Enseignez sur la stack AHA", "subtitle": "D'un cours à une académie complète : contenu structuré, paiements intégrés, rendu serveur.", "primary_cta": {"label": "Voir les tarifs"}, "secondary_cta": {"label": "Contactez-nous"}}}},
        "de": {"title": "Precis LMS", "content": {"tagline": "Die Lernplattform hinter structa.cloud: Kurse, Einschreibungen, Zahlungen.", "hero": {"title": "Precis LMS", "subtitle": "Eine inhaltsgetriebene Lernplattform auf Django + django-fusion mit einer Next.js-Frontend.", "primary_cta": {"label": "Editionen ansehen"}, "secondary_cta": {"label": "Mehr erfahren"}}, "cta": {"title": "Unterrichten auf dem AHA-Stack", "subtitle": "Von einem Kurs zur ganzen Akademie: inhaltsgetrieben, mit Zahlungen und Server-Rendering.", "primary_cta": {"label": "Preise ansehen"}, "secondary_cta": {"label": "Kontakt aufnehmen"}}}},
        "es": {"title": "Precis LMS", "content": {"tagline": "La plataforma de aprendizaje detrás de structa.cloud: cursos, inscripciones, pagos.", "hero": {"title": "Precis LMS", "subtitle": "Una plataforma de aprendizaje basada en contenido, construida con Django + django-fusion y un frontend Next.js.", "primary_cta": {"label": "Ver las ediciones"}, "secondary_cta": {"label": "Saber más"}}, "cta": {"title": "Enseña en el stack AHA", "subtitle": "De un curso a una academia completa: contenido estructurado, pagos integrados y renderizado en servidor.", "primary_cta": {"label": "Ver precios"}, "secondary_cta": {"label": "Contacte con nosotros"}}}},
        "pt": {"title": "Precis LMS", "content": {"tagline": "A plataforma de aprendizagem por trás do structa.cloud: cursos, inscrições, pagamentos.", "hero": {"title": "Precis LMS", "subtitle": "Uma plataforma de aprendizagem orientada por conteúdo, construída em Django + django-fusion com frontend Next.js.", "primary_cta": {"label": "Ver as edições"}, "secondary_cta": {"label": "Saber mais"}}, "cta": {"title": "Ensine na stack AHA", "subtitle": "De um curso a uma academia completa: conteúdo estruturado, pagamentos integrados e renderização no servidor.", "primary_cta": {"label": "Ver preços"}, "secondary_cta": {"label": "Fale connosco"}}}},
    },
    "cms": {
        "ar": {"title": "لوب CRM", "content": {"tagline": "مسار أكثر هدوءاً من الاهتمام الاجتماعي إلى المحادثة التالية مع العميل.", "hero": {"title": "لوب CRM", "subtitle": "مساحة عمل متصلة بالعملاء تساعد الفرق على تحويل الاهتمام إلى محادثات وفرص مفيدة.", "primary_cta": {"label": "اطّلع على الإصدارات"}, "secondary_cta": {"label": "استكشف المكدّس"}}, "cta": {"title": "انضم إلى قائمة انتظار لوب CRM", "subtitle": "أخبرنا أين تشعر أن متابعة العملاء أصعب مما ينبغي، وساعدنا في بناء نقطة بداية أكثر هدوءاً.", "primary_cta": {"label": "انضم إلى القائمة"}, "secondary_cta": {"label": "اقرأ التوثيق"}}}},
        "sv": {"title": "Loop CRM", "content": {"tagline": "En lugnare väg från social uppmärksamhet till nästa kundsamtal.", "hero": {"title": "Loop CRM", "subtitle": "En sammankopplad kundarbetsyta som hjälper team att förvandla uppmärksamhet till användbara samtal och möjligheter.", "primary_cta": {"label": "Se utgåvorna"}, "secondary_cta": {"label": "Utforska stacken"}}, "cta": {"title": "Gå med i Loop CRM:s väntelista", "subtitle": "Berätta var kunduppföljning känns svårare än den borde, och hjälp oss forma en lugnare startpunkt.", "primary_cta": {"label": "Gå med i väntelistan"}, "secondary_cta": {"label": "Läs dokumentationen"}}}},
        "fr": {"title": "Loop CRM", "content": {"tagline": "Un chemin plus calme de l'attention sociale à la prochaine conversation client.", "hero": {"title": "Loop CRM", "subtitle": "Un espace de travail client connecté qui aide les équipes à transformer l'attention en conversations et opportunités utiles.", "primary_cta": {"label": "Voir les éditions"}, "secondary_cta": {"label": "Explorer la stack"}}, "cta": {"title": "Rejoignez la liste d'attente Loop CRM", "subtitle": "Dites-nous où le suivi client semble plus difficile qu'il ne devrait, et aidez-nous à bâtir un point de départ plus calme.", "primary_cta": {"label": "Rejoindre la liste"}, "secondary_cta": {"label": "Lire la documentation"}}}},
        "de": {"title": "Loop CRM", "content": {"tagline": "Ein ruhigerer Weg von sozialer Aufmerksamkeit zum nächsten Kundengespräch.", "hero": {"title": "Loop CRM", "subtitle": "Ein vernetzter Kundenarbeitsbereich, der Teams hilft, Aufmerksamkeit in nützliche Gespräche und Chancen zu verwandeln.", "primary_cta": {"label": "Editionen ansehen"}, "secondary_cta": {"label": "Stack erkunden"}}, "cta": {"title": "Treten Sie der Loop-CRM-Warteliste bei", "subtitle": "Erzählen Sie uns, wo Kunden-Follow-up schwerer ist als nötig, und helfen Sie uns, einen ruhigeren Ausgangspunkt zu gestalten.", "primary_cta": {"label": "Warteliste beitreten"}, "secondary_cta": {"label": "Dokumentation lesen"}}}},
        "es": {"title": "Loop CRM", "content": {"tagline": "Un camino más tranquilo de la atención social a la siguiente conversación con el cliente.", "hero": {"title": "Loop CRM", "subtitle": "Un espacio de trabajo de clientes conectado que ayuda a los equipos a convertir la atención en conversaciones y oportunidades útiles.", "primary_cta": {"label": "Ver las ediciones"}, "secondary_cta": {"label": "Explorar el stack"}}, "cta": {"title": "Únase a la lista de espera de Loop CRM", "subtitle": "Cuéntenos dónde el seguimiento del cliente es más difícil de lo necesario y ayúdenos a crear un punto de partida más tranquilo.", "primary_cta": {"label": "Unirse a la lista"}, "secondary_cta": {"label": "Leer la documentación"}}}},
        "pt": {"title": "Loop CRM", "content": {"tagline": "Um caminho mais calmo da atenção social para a próxima conversa com o cliente.", "hero": {"title": "Loop CRM", "subtitle": "Um espaço de trabalho de clientes conectado que ajuda as equipas a transformar atenção em conversas e oportunidades úteis.", "primary_cta": {"label": "Ver as edições"}, "secondary_cta": {"label": "Explorar a stack"}}, "cta": {"title": "Junte-se à lista de espera do Loop CRM", "subtitle": "Diga-nos onde o acompanhamento do cliente é mais difícil do que deveria e ajude-nos a criar um ponto de partida mais calmo.", "primary_cta": {"label": "Entrar na lista"}, "secondary_cta": {"label": "Ler a documentação"}}}},
    },
    "cypercloud": {
        "ar": {"title": "سينتارا", "content": {"tagline": "مخصّص دردشة ذكاء اصطناعي. ادمج دردشة مدعومة بـ Syntara في أي موقع.", "hero": {"title": "سينتارا", "subtitle": "منصة تخصيص دردشة ذكاء اصطناعي. دردشة مدعومة بـ ceptor-ai مدمجة في مواقع العملاء، بهوية كاملة.", "primary_cta": {"label": "اطّلع على الإصدارات"}, "secondary_cta": {"label": "عرض ceptor-ai على GitHub"}}, "cta": {"title": "دردشة تشبه علامتك التجارية", "subtitle": "ادمج دردشة مدعومة بـ Syntara في غضون بعد ظهر واحد.", "primary_cta": {"label": "ابدأ الآن"}, "secondary_cta": {"label": "عرض ceptor-ai على GitHub"}}}},
        "sv": {"title": "Syntara", "content": {"tagline": "AI-chattanpassare. Bädda in Syntara-driven chatt på vilken webbplats som helst.", "hero": {"title": "Syntara", "subtitle": "En plattform för att anpassa AI-chatt. Ceptor-ai-driven chatt inbäddad på kundwebbplatser, helt varumärkt.", "primary_cta": {"label": "Se utgåvorna"}, "secondary_cta": {"label": "Visa ceptor-ai på GitHub"}}, "cta": {"title": "Chatt som matchar ditt varumärke", "subtitle": "Bädda in Syntara-driven chatt på en eftermiddag.", "primary_cta": {"label": "Kom igång"}, "secondary_cta": {"label": "Visa ceptor-ai på GitHub"}}}},
        "fr": {"title": "Syntara", "content": {"tagline": "Personnalisateur de chat IA. Intégrez un chat propulsé par Syntara sur n'importe quel site.", "hero": {"title": "Syntara", "subtitle": "Une plateforme de personnalisation de chat IA. Un chat propulsé par ceptor-ai intégré aux sites clients, entièrement aux couleurs de la marque.", "primary_cta": {"label": "Voir les éditions"}, "secondary_cta": {"label": "Voir ceptor-ai sur GitHub"}}, "cta": {"title": "Un chat aux couleurs de votre marque", "subtitle": "Intégrez un chat propulsé par Syntara en un après-midi.", "primary_cta": {"label": "Commencer"}, "secondary_cta": {"label": "Voir ceptor-ai sur GitHub"}}}},
        "de": {"title": "Syntara", "content": {"tagline": "KI-Chat-Anpassung. Betten Sie Syntara-gestützten Chat auf jeder Website ein.", "hero": {"title": "Syntara", "subtitle": "Eine Plattform zur Anpassung von KI-Chat. Ceptor-ai-gestützter Chat, eingebettet in Kundenseiten, vollständig gebrandet.", "primary_cta": {"label": "Editionen ansehen"}, "secondary_cta": {"label": "ceptor-ai auf GitHub ansehen"}}, "cta": {"title": "Chat im Look Ihrer Marke", "subtitle": "Betten Sie Syntara-gestützten Chat an einem Nachmittag ein.", "primary_cta": {"label": "Loslegen"}, "secondary_cta": {"label": "ceptor-ai auf GitHub ansehen"}}}},
        "es": {"title": "Syntara", "content": {"tagline": "Personalizador de chat de IA. Integra chat con tecnología Syntara en cualquier sitio.", "hero": {"title": "Syntara", "subtitle": "Una plataforma para personalizar el chat de IA. Chat con tecnología ceptor-ai integrado en sitios de clientes, totalmente personalizado con su marca.", "primary_cta": {"label": "Ver las ediciones"}, "secondary_cta": {"label": "Ver ceptor-ai en GitHub"}}, "cta": {"title": "Un chat con la imagen de tu marca", "subtitle": "Integra el chat con tecnología Syntara en una tarde.", "primary_cta": {"label": "Empezar"}, "secondary_cta": {"label": "Ver ceptor-ai en GitHub"}}}},
        "pt": {"title": "Syntara", "content": {"tagline": "Personalizador de chat de IA. Incorpore chat com tecnologia Syntara em qualquer site.", "hero": {"title": "Syntara", "subtitle": "Uma plataforma de personalização de chat de IA. Chat com tecnologia ceptor-ai incorporado em sites de clientes, totalmente com a sua marca.", "primary_cta": {"label": "Ver as edições"}, "secondary_cta": {"label": "Ver ceptor-ai no GitHub"}}, "cta": {"title": "Chat com a imagem da sua marca", "subtitle": "Incorpore chat com tecnologia Syntara numa tarde.", "primary_cta": {"label": "Começar"}, "secondary_cta": {"label": "Ver ceptor-ai no GitHub"}}}},
    },
    "vresume": {
        "ar": {"title": "فيريزيوم", "content": {"tagline": "منصة سير ذاتية سحابية. أنشئ وحدّث وانشر سيراً ذاتية احترافية — مع ملخصات ذكاء اصطناعي مدعومة بـ Syntara.", "hero": {"title": "فيريزيوم", "subtitle": "منشئ سير ذاتية مستضاف في السحابة مع قوالب عصرية ونطاقات مخصصة ونشر عبر CI/CD وملخصات ذكاء اصطناعي من Syntara.", "primary_cta": {"label": "شغّل فيريزيوم"}, "secondary_cta": {"label": "اطّلع على الإصدارات"}}, "cta": {"title": "مسيرتك المهنية، منشورة", "subtitle": "ابنِ سيرة ذاتية تُطلق كمنتج.", "primary_cta": {"label": "شغّل فيريزيوم"}, "secondary_cta": {"label": "تواصل معنا"}}}},
        "sv": {"title": "vResume", "content": {"tagline": "Molnbaserad CV-plattform. Skapa, uppdatera och publicera professionella CV:n — med Syntara-drivna AI-sammanfattningar.", "hero": {"title": "vResume", "subtitle": "En molnbaserad CV-byggare med moderna mallar, egna domäner, CI/CD-deployments och AI-profilssammanfattningar från Syntara.", "primary_cta": {"label": "Starta vResume"}, "secondary_cta": {"label": "Se utgåvorna"}}, "cta": {"title": "Din karriär, publicerad", "subtitle": "Bygg ett CV som lanseras som en produkt.", "primary_cta": {"label": "Starta vResume"}, "secondary_cta": {"label": "Kontakta oss"}}}},
        "fr": {"title": "vResume", "content": {"tagline": "Plateforme de CV cloud. Créez, mettez à jour et publiez des CV professionnels — avec des résumés IA propulsés par Syntara.", "hero": {"title": "vResume", "subtitle": "Un créateur de CV hébergé dans le cloud avec des modèles modernes, des domaines personnalisés, des déploiements CI/CD et des résumés de profil IA Syntara.", "primary_cta": {"label": "Lancer vResume"}, "secondary_cta": {"label": "Voir les éditions"}}, "cta": {"title": "Votre carrière, publiée", "subtitle": "Créez un CV qui se lance comme un produit.", "primary_cta": {"label": "Lancer vResume"}, "secondary_cta": {"label": "Contactez-nous"}}}},
        "de": {"title": "vResume", "content": {"tagline": "Cloud-Lebenslauf-Plattform. Erstellen, aktualisieren und veröffentlichen Sie professionelle Lebensläufe — mit Syntara-gestützten KI-Zusammenfassungen.", "hero": {"title": "vResume", "subtitle": "Ein cloud-gehosteter Lebenslauf-Builder mit modernen Vorlagen, eigenen Domains, CI/CD-Deployments und KI-Profilzusammenfassungen von Syntara.", "primary_cta": {"label": "vResume starten"}, "secondary_cta": {"label": "Editionen ansehen"}}, "cta": {"title": "Ihre Karriere, veröffentlicht", "subtitle": "Erstellen Sie einen Lebenslauf, der wie ein Produkt veröffentlicht wird.", "primary_cta": {"label": "vResume starten"}, "secondary_cta": {"label": "Kontakt aufnehmen"}}}},
        "es": {"title": "vResume", "content": {"tagline": "Plataforma de currículums en la nube. Crea, actualiza y publica currículums profesionales — con resúmenes de IA con tecnología Syntara.", "hero": {"title": "vResume", "subtitle": "Un creador de currículums alojado en la nube con plantillas modernas, dominios personalizados, despliegues CI/CD y resúmenes de perfil con IA Syntara.", "primary_cta": {"label": "Lanzar vResume"}, "secondary_cta": {"label": "Ver las ediciones"}}, "cta": {"title": "Tu carrera, publicada", "subtitle": "Crea un currículum que se lance como un producto.", "primary_cta": {"label": "Lanzar vResume"}, "secondary_cta": {"label": "Contacte con nosotros"}}}},
        "pt": {"title": "vResume", "content": {"tagline": "Plataforma de currículos na nuvem. Crie, atualize e publique currículos profissionais — com resumos de IA com tecnologia Syntara.", "hero": {"title": "vResume", "subtitle": "Um criador de currículos alojado na nuvem com modelos modernos, domínios personalizados, deployments CI/CD e resumos de perfil com IA Syntara.", "primary_cta": {"label": "Iniciar vResume"}, "secondary_cta": {"label": "Ver as edições"}}, "cta": {"title": "A sua carreira, publicada", "subtitle": "Crie um currículo que se lança como um produto.", "primary_cta": {"label": "Iniciar vResume"}, "secondary_cta": {"label": "Fale connosco"}}}},
    },
    "precis-ctc": {
        "ar": {"title": "أبحاث CTC", "content": {"tagline": "مساحة عمل بحثية مركّزة تساعد الفرق على تحويل الأدلة إلى قرارات ومشاركة العمل المفيد بثقة.", "hero": {"title": "أبحاث CTC", "subtitle": "امنح فرق البحث مساراً أوضح من السؤال إلى الدليل، مع مساحة عمل تُبقي الناس والتقدّم والقرارات متحركة معاً.", "primary_cta": {"label": "استكشف الفوائد"}, "secondary_cta": {"label": "تحدّث عن سير عملك"}, "trusted_by": "أدلة أوضح · تعاون أكثر هدوءاً · قرارات أفضل"}, "cta": {"title": "اجعل قرار البحث التالي أسهل", "subtitle": "أحضر سير عمل واحداً تشعر أنه أصعب مما ينبغي. سنساعدك في إيجاد نقطة بداية أكثر هدوءاً.", "primary_cta": {"label": "تحدث إلينا"}, "secondary_cta": {"label": "شاهد كل المنتجات"}}}},
        "sv": {"title": "CTC Research", "content": {"tagline": "Ett fokuserat forskningsarbetsområde som hjälper team att omvandla underlag till beslut och dela användbart arbete med förtroende.", "hero": {"title": "CTC Research", "subtitle": "Ge forskningsteam en tydligare väg från fråga till underlag, med en arbetsyta som håller människor, framsteg och beslut i rörelse tillsammans.", "primary_cta": {"label": "Utforska fördelarna"}, "secondary_cta": {"label": "Prata om ert arbetssätt"}, "trusted_by": "Tydligare underlag · lugnare samarbete · bättre beslut"}, "cta": {"title": "Gör nästa forskningsbeslut enklare", "subtitle": "Ta med ett arbetssätt som känns svårare än det borde. Vi hjälper dig hitta en lugnare startpunkt.", "primary_cta": {"label": "Prata med oss"}, "secondary_cta": {"label": "Se alla produkter"}}}},
        "fr": {"title": "CTC Research", "content": {"tagline": "Un espace de travail de recherche ciblé qui aide les équipes à transformer les preuves en décisions et à partager un travail utile en toute confiance.", "hero": {"title": "CTC Research", "subtitle": "Offrez aux équipes de recherche un chemin plus clair de la question à la preuve, avec un espace de travail qui fait avancer ensemble les personnes, les progrès et les décisions.", "primary_cta": {"label": "Explorer les bénéfices"}, "secondary_cta": {"label": "Parler de votre flux de travail"}, "trusted_by": "Preuves plus claires · collaboration plus sereine · meilleures décisions"}, "cta": {"title": "Facilitez la prochaine décision de recherche", "subtitle": "Apportez un flux de travail qui vous semble plus difficile qu'il ne devrait. Nous vous aiderons à trouver un point de départ plus serein.", "primary_cta": {"label": "Parlez-nous"}, "secondary_cta": {"label": "Voir tous les produits"}}}},
        "de": {"title": "CTC Research", "content": {"tagline": "Ein fokussierter Forschungsarbeitsbereich, der Teams hilft, Belege in Entscheidungen zu verwandeln und nützliche Arbeit selbstbewusst zu teilen.", "hero": {"title": "CTC Research", "subtitle": "Geben Sie Forschungsteams einen klareren Weg von der Frage zum Beleg — mit einem Arbeitsbereich, der Menschen, Fortschritt und Entscheidungen gemeinsam in Bewegung hält.", "primary_cta": {"label": "Vorteile entdecken"}, "secondary_cta": {"label": "Über Ihren Workflow sprechen"}, "trusted_by": "Klarere Belege · ruhigere Zusammenarbeit · bessere Entscheidungen"}, "cta": {"title": "Machen Sie die nächste Forschungsentscheidung einfacher", "subtitle": "Bringen Sie einen Workflow mit, der sich schwerer anfühlt als nötig. Wir helfen Ihnen, einen ruhigeren Ausgangspunkt zu finden.", "primary_cta": {"label": "Sprechen Sie mit uns"}, "secondary_cta": {"label": "Alle Produkte ansehen"}}}},
        "es": {"title": "CTC Research", "content": {"tagline": "Un espacio de trabajo de investigación enfocado que ayuda a los equipos a convertir la evidencia en decisiones y a compartir trabajo útil con confianza.", "hero": {"title": "CTC Research", "subtitle": "Dé a los equipos de investigación un camino más claro de la pregunta a la evidencia, con un espacio de trabajo que mantiene a las personas, el progreso y las decisiones avanzando juntos.", "primary_cta": {"label": "Explorar los beneficios"}, "secondary_cta": {"label": "Hable de su flujo de trabajo"}, "trusted_by": "Evidencia más clara · colaboración más serena · mejores decisiones"}, "cta": {"title": "Facilite la próxima decisión de investigación", "subtitle": "Traiga un flujo de trabajo que se sienta más difícil de lo necesario. Le ayudaremos a encontrar un punto de partida más sereno.", "primary_cta": {"label": "Hable con nosotros"}, "secondary_cta": {"label": "Ver todos los productos"}}}},
        "pt": {"title": "CTC Research", "content": {"tagline": "Um espaço de trabalho de investigação focado que ajuda as equipas a transformar evidência em decisões e a partilhar trabalho útil com confiança.", "hero": {"title": "CTC Research", "subtitle": "Dê às equipas de investigação um caminho mais claro da pergunta à evidência, com um espaço de trabalho que mantém pessoas, progresso e decisões a avançar em conjunto.", "primary_cta": {"label": "Explorar os benefícios"}, "secondary_cta": {"label": "Fale sobre o seu fluxo de trabalho"}, "trusted_by": "Evidência mais clara · colaboração mais serena · melhores decisões"}, "cta": {"title": "Facilite a próxima decisão de investigação", "subtitle": "Traga um fluxo de trabalho que pareça mais difícil do que deveria. Ajudamo-lo a encontrar um ponto de partida mais sereno.", "primary_cta": {"label": "Fale connosco"}, "secondary_cta": {"label": "Ver todos os produtos"}}}},
    },
    "ceptor-ai": {
        "ar": {"title": "سبتور-إيه آي", "content": {"tagline": "عميل دردشة ذكاء اصطناعي + خادم MCP. تواصل وتوليد للوكلاء.", "hero": {"title": "سبتور-إيه آي", "subtitle": "عميل دردشة ذكاء اصطناعي مع خادم بروتوكول سياق النموذج (MCP). يمدّ Syntara وأدوات الوكلاء بالطاقة.", "primary_cta": {"label": "عرض على GitHub"}, "secondary_cta": {"label": "اطّلع على الإصدارات"}}, "cta": {"title": "وكلاء يتحدثون إلى أدواتك", "subtitle": "يربط ceptor-ai نماذج اللغة بأي شيء عبر MCP.", "primary_cta": {"label": "عرض على GitHub"}, "secondary_cta": {"label": "شاهد سينتارا"}}}},
        "sv": {"title": "ceptor-ai", "content": {"tagline": "AI-chattklient + MCP-server. Agentkommunikation och generering.", "hero": {"title": "ceptor-ai", "subtitle": "En AI-chattklient med en Model Context Protocol (MCP)-server. Driver Syntara och agentverktyg.", "primary_cta": {"label": "Visa på GitHub"}, "secondary_cta": {"label": "Se utgåvorna"}}, "cta": {"title": "Agenter som pratar med dina verktyg", "subtitle": "ceptor-ai kopplar LLM:er till allt via MCP.", "primary_cta": {"label": "Visa på GitHub"}, "secondary_cta": {"label": "Se Syntara"}}}},
        "fr": {"title": "ceptor-ai", "content": {"tagline": "Client de chat IA + serveur MCP. Communication et génération pour agents.", "hero": {"title": "ceptor-ai", "subtitle": "Un client de chat IA avec un serveur Model Context Protocol (MCP). Alimente Syntara et les outils d'agents.", "primary_cta": {"label": "Voir sur GitHub"}, "secondary_cta": {"label": "Voir les éditions"}}, "cta": {"title": "Des agents qui parlent à vos outils", "subtitle": "ceptor-ai connecte les LLM à tout via MCP.", "primary_cta": {"label": "Voir sur GitHub"}, "secondary_cta": {"label": "Voir Syntara"}}}},
        "de": {"title": "ceptor-ai", "content": {"tagline": "KI-Chat-Client + MCP-Server. Agent-Kommunikation und -Generierung.", "hero": {"title": "ceptor-ai", "subtitle": "Ein KI-Chat-Client mit einem Model Context Protocol (MCP)-Server. Treibt Syntara und Agent-Tools an.", "primary_cta": {"label": "Auf GitHub ansehen"}, "secondary_cta": {"label": "Editionen ansehen"}}, "cta": {"title": "Agenten, die mit Ihren Tools sprechen", "subtitle": "ceptor-ai verbindet LLMs über MCP mit allem.", "primary_cta": {"label": "Auf GitHub ansehen"}, "secondary_cta": {"label": "Syntara ansehen"}}}},
        "es": {"title": "ceptor-ai", "content": {"tagline": "Cliente de chat de IA + servidor MCP. Comunicación y generación para agentes.", "hero": {"title": "ceptor-ai", "subtitle": "Un cliente de chat de IA con un servidor Model Context Protocol (MCP). Impulsa Syntara y las herramientas de agentes.", "primary_cta": {"label": "Ver en GitHub"}, "secondary_cta": {"label": "Ver las ediciones"}}, "cta": {"title": "Agentes que hablan con tus herramientas", "subtitle": "ceptor-ai conecta los LLM con cualquier cosa mediante MCP.", "primary_cta": {"label": "Ver en GitHub"}, "secondary_cta": {"label": "Ver Syntara"}}}},
        "pt": {"title": "ceptor-ai", "content": {"tagline": "Cliente de chat de IA + servidor MCP. Comunicação e geração para agentes.", "hero": {"title": "ceptor-ai", "subtitle": "Um cliente de chat de IA com um servidor Model Context Protocol (MCP). Alimenta o Syntara e as ferramentas de agentes.", "primary_cta": {"label": "Ver no GitHub"}, "secondary_cta": {"label": "Ver as edições"}}, "cta": {"title": "Agentes que falam com as suas ferramentas", "subtitle": "O ceptor-ai liga os LLM a qualquer coisa via MCP.", "primary_cta": {"label": "Ver no GitHub"}, "secondary_cta": {"label": "Ver Syntara"}}}},
    },
}
...
DEFAULT_BLOG_POST_BODIES = {
    ...
    "advanced-content-architecture": (
        ...
        "<p>Ready to apply the pattern? <a href=\"/services/benefits/\">Review the shared stack</a>, then <a href=\"/contact/\">start a conversation</a> about the smallest useful surface for your team.</p>"
    ),
}
                    ...
                    "editions": [
                        {
                            ...
                            "price": "$0",
                            "period": "/open source",
                            "offer_label": "Offline-first · open source",
            ...
            (
                "features",
                {
                    ...
                    "features": [
                        ...
                        {"icon": "M1 1l22 22M16.72 11.06A10.94 10.94 0 0119 12.55M5 12.55a10.94 10.94 0 015.17-2.39M10.71 5.05A16 16 0 0122.58 9M1.42 9a15.91 15.91 0 014.7-2.88M8.53 16.11a6 6 0 016.95 0M12 20h.01", "title": "Offline-first mode", "description": "The Community terminal keeps selling through an internet outage - the local SQLite core stays live and an offline banner shows until connectivity returns."},
                        {"icon": "M3 12a9 9 0 109-9 9.75 9.75 0 00-6.74 2.74L3 8M3 3v5h5", "title": "Refunds & returns", "description": "Issue refunds straight from the transactions list with a confirmation flow that restores stock and updates the day's totals in one step."},
                    ],
                },
            ),
            (
        ...
        "hero": [
            (
                "hero",
                {
                    ...
                    "secondary_cta": {"label": "Explore the stack", "href": "/services/benefits/", "style": "white"},
                },
            )
        ],
        "body": (
        ...
        "hero": [
            (
                "hero",
                {
                    ...
                    "primary_cta": {"label": "Explore the benefits", "href": "/products/precis-ctc/#features", "style": "secondary"},
                ...
                "items": [
                    {
                        ...
                        "answer": "Structa Cloud is the portfolio and product hub for Mahmoud: a full-stack developer building Django/Wagtail platforms, AI tools, and open-source libraries.",
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "answer": "Clone the monorepo from github.com/mammhoud, run 'make dev' in projects/precis/precis-landing, and explore the Wagtail admin at /admin/. Product pages show outcomes and visual previews; implementation references live in the engineering blog posts.",
                    },
                    {
...
DEFAULT_FOUNDER_SECTIONS = {
    "hero": [
        (
            ...
            {
                "title": "Mahmoud",
                "subtitle": "Founder & CEO — full-stack developer, open-source contributor, and the engineer behind structa.cloud. Django, Wagtail, and AI-powered systems.",
    ...
    "body": (
        "<p>Mahmoud is a full-stack developer specializing in "
