/**
 * Per-project webpack config — Precis LMS (`projects/precis/main`).
 *
 ...
 *
 * Output lands in `projects/precis/main/assets/bundles/main/` and is published
 * under `/static/bundles/main/`, matching the per-site `BUNDLE_DIR_NAME` in
 * `projects/precis/main/backend/configs/base/assets.py`.
 *
 * Usage (from `projects/precis/main/assets/`):
