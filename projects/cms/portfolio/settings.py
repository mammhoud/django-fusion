...
# Unfold admin login branding — shows the CRM isometric logo on Unfold's
# custom login page. The site-specific templates/wagtailadmin/login.html
# handles Wagtail's default login page via the branding_login block.
# These are mutually exclusive render paths (Unfold vs Wagtail default).
UNFOLD["LOGIN"] = {
    "image": lambda request: static("images/brand/crm-isometric.svg"),
}
# ============================================================
