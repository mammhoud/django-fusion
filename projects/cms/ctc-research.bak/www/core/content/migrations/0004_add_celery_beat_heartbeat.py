...
the original `content` app). Path: `projects/ctc-research/www/projects/content/`
...
to point at `projects/<site>/www/migrations/`. Django therefore classifies
...
# projects/ctc-research/www/worker/tasks.py.
