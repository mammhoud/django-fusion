...
class EventPage(BaseIndexPage):
    ...
    # LMS-only template — see `projects/lms/templates/events/event_page.html`.
    ...
    def get_listed_items(self):
        ...
        Mirrors ``plugins/accounts/views/events.py EventListView``
        queryset so /events/ renders identically through the Wagtail
        page or the plugin URL.
        """
