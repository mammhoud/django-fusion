...
Centralized Django configuration for the pos-full server server.
...
FUSION_RENDER_FIRST = os.environ.get("FUSION_RENDER_FIRST", "1") == "1"
# Legacy alias — django-fusion's canonical resolver reads ``FUSION_RENDER_FIRST``
# first; keep this name for older call sites (e.g. manage.py --ensure-superuser).
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            # so `{% load components %}` works (mirrors precis-landing).
            "libraries": {
