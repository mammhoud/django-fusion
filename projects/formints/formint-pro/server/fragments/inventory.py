...
Template context::
    ...
    {
        "total_products": 150,
        "total_ingredients": 80,
        "low_stock_items": [{"name": "...", "qty": 2, "reorder": 10}, ...],
...
class InventoryFragment(FragmentComponent):
    ...
    def get_context(self, **kwargs: Any) -> dict[str, Any]:
        ...
        # Low-stock ingredients (current qty <= reorder level)
        low_stock = list(
        ...
        # Total inventory value (ingredient cost * qty)
        inv_value = (
