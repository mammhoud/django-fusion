...
The desktop app consumes django-fusion "components as data" from the server
backend:
...
server API is unreachable, the frontend transport falls back to Tauri
...
class ComponentsController:
    """django-fusion data components served as JSON (server backend)."""
