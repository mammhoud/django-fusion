"""
Formint — Sync API controllers (cloud sidecar sync).

Exposes the merged POS ``ProductSyncEngine`` (``services/sync.py``) through
the Ninja API so the desktop app can drive cloud-sidecar sync over HTTP
...
class SyncController:
    """Cloud sidecar sync — push/pull/approve across POS nodes."""
