# Pinia ↔ Server API Integration Guide (legacy)

> **Version:** 1.0.0 — **Last Updated:** 20 July 2026
> **Applies to:** pos-solo (port 8765), pos-full (port 8766)
> **Archived:** moved to `docs/legacy/` (21 Aug 2026). Robyn was removed from
> the Pro and Cloud editions — Django serves the API surface now. This is the
> merged successor of the former `PINIA_API.md` + `PINIA_INTEGRATION.md`
> duplicate pair (the API endpoint summary and React-hooks variant from
> `PINIA_API.md` are folded into this guide's store maps and appendix).
...
```
## 7. React Hooks Version (from PINIA_API.md)
...
## 8. API Endpoint Summary (from PINIA_API.md)
