        ...
        {showForm && (
          <Card spaceY="3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <input type="datetime-local" value={form.shift_start} onChange={e => setForm({ ...form, shift_start: e.target.value })} required className="input w-full" />
              <input type="datetime-local" value={form.shift_end} onChange={e => setForm({ ...form, shift_end: e.target.value })} required className="input w-full" />
              <input type="text" value={form.notes} onChange={e => setForm({ ...form, notes: e.target.value })} placeholder={t('schedule.notes')} className="input w-full" />
            </div>
