 ...
 * Sidecar API Client
 * ==================
 * Base HTTP client for communicating with the POS Cloud Robyn sidecar
...
/** Base URL of the POS Cloud sidecar (Robyn, shares the pos-cloud Django ORM) */
...
export const SIDECAR_WS_BASE =
  (import.meta.env?.VITE_SIDECAR_WS_URL as string | undefined) || 'ws://127.0.0.1:8767';
