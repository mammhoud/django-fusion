 ...
 * Server API Client
 * ==================
 * Base HTTP client for communicating with the POS Cloud Robyn server
 * (backend/apps.core Django ORM served over Robyn). All API modules use
 * this client for typed, error-handled requests.
 *
 * Usage:
...
/** Base URL of the Formint Cloud server (Django ORM) */
export const SERVER_BASE =
  (import.meta.env?.VITE_SERVER_URL as string | undefined) || 'http://127.0.0.1:8767';

/** WebSocket base URL */
export const SERVER_WS_BASE =
  (import.meta.env?.VITE_SERVER_WS_URL as string | undefined) || 'ws://127.0.0.1:8767';
