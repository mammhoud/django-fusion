...
## Scope
This directory is a site-specific template root for `projects/ctc-research/templates`. Follow the shared template rules in `projects/assets/templates/AGENTS.md` first, then apply these local notes.
