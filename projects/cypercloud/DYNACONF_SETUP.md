...
```yaml
DJANGO:
  secret_key: "{{ env 'TINKER_SECRET_KEY' or 'django-insecure-cypercloud-dev' }}"
  debug: "{{ env 'TINKER_DEBUG' or true }}"
  allowed_hosts:
    - "{{ env 'TINKER_ALLOWED_HOSTS' or 'localhost,127.0.0.1,cypercloud.localhost' }}"
```
