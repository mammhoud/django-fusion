...
1. **Frontend Build (Webpack)** - ✅ SUCCESS
   ...
   - Output: `assets/bundles/cypercloud/`

2. **Static Files Collection** - ✅ SUCCESS
   - 192 static files collected
   - Collected to: `/home/structa.cloud/projects/cypercloud/staticfiles`
...
3. **Database Migration** - ❌ FAILED (URL Configuration Issue)
   ...
   - This is expected - the app was renamed from `customizer` to `cypercloud`
...
✓ Mode: production
✓ Output: /home/structa.cloud/projects/cypercloud/assets/bundles/cypercloud/
...
```
Source: assets/bundles/cypercloud/ and other static sources
Destination: /home/structa.cloud/projects/cypercloud/staticfiles/
...
**Cause**: Module renamed from `customizer` to `cypercloud`, but URLs still reference old name

**Resolution**:
```python
# Change to:
path("customizer/", include("cypercloud.site")),  # OR adjust path as needed
```
...
```bash
cd /home/structa.cloud/projects/cypercloud
...
```bash
# 1. Fix urls.py (edit and update customizer references to cypercloud)
