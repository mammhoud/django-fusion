...
**Scope:** `projects/structa.cloud/assets/templates/plugins/`
...
- Auth/account templates: `projects/structa.cloud/backend/apps/auth/` or the owning
  account feature under `backend/apps/pages/`.
- Learning templates: `projects/structa.cloud/backend/apps/learning/`.
- Blog/profile/product/page templates: the corresponding
  `backend/apps/pages/<feature>/templates/` directory.
- Site-root overrides: `projects/structa.cloud/backend/templates/`.
