#!/usr/bin/env python3
"""Project-local management entry point for ctc-research."""
...
def main() -> None:
    ...
    os.environ.setdefault("DJANGO_SITE", "precis-ctc")
    os.environ.setdefault("DJANGO_WEBSITE", "precis-ctc")
    os.environ.setdefault("WEBSITE", "precis-ctc")
    os.environ.setdefault("WEBSITE_NAME", "precis-ctc")
    os.environ.setdefault("PROJECT_PATH", "precis-ctc")
