    ...
    def _ensure_site_content(self, site):
        ...
        try:
            ...
            SiteSettings.objects.get_or_create(
                site=site,
                defaults={
                    "site_name": getattr(settings, "FUSION_SITE_NAME", "CTC Research"),
                    "site_tagline": "Evidence you can build on.",
                    "footer_description": "Medical research education and evidence services for clinical and research teams.",
                    "footer_copyright": "© 2026 CTC Research",
