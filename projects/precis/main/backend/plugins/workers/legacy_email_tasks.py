"""Precis legacy email jobs migrated from Celery and Django-RQ to Dramatiq."""
...
@task(queue="email", max_retries=3, min_backoff=2_000, actor_name="precis.email.send_template")
def send_template_email(
    ...
    """Send a template email for services that do not own an EmailLog."""
