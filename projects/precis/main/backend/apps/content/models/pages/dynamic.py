...
Each page type uses StreamField blocks from apps.content.models.blocks.cms so
...
from apps.content.models.blocks.cms import PAGE_CONTENT_BLOCKS, DASHBOARD_CONTENT_BLOCKS
