...
Generated URL prefix: /components/
  /components/lms/dashboard/
  /components/lms/courses/list-fragment/   (HTMX only)
  /components/blog/posts/list-fragment/    (HTMX only)
  /components/blog/posts/create-fragment/  (HTMX only)
"""
