...
- [Legacy Landing-Fusion docs](../../precis-landing/docs/README.md) — kept legacy copy (only landing-specific files)
...
- This directory is the canonical home for the shared Precis docs; the legacy
  `precis-landing/docs/` copy keeps only landing-specific files and links here.
