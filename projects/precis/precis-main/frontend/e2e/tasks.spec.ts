 ...
 * Django backend road. Mirrors the auth-gate contract of learning.spec.ts:
 * anonymous traffic must be bounced to allauth login with a `next` target,
 * never render the audit table.
 */
