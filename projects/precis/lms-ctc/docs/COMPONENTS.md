...
This works because landing-fusion is a simpler project — one layout, fewer templates.
...
| `projects/precis/main/assets/templates/` | Primary comp user — all layout skeletons + components |
