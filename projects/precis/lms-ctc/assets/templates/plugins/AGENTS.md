...
**Scope:** `projects/precis/main/assets/templates/plugins/`
...
- Auth/account templates: `projects/precis/main/backend/apps/auth/` or the owning
  account feature under `backend/apps/pages/`.
- Learning templates: `projects/precis/main/backend/apps/learning/`.
- Blog/profile/product/page templates: the corresponding
  `backend/apps/pages/<feature>/templates/` directory.
- Site-root overrides: `projects/precis/main/backend/templates/`.
