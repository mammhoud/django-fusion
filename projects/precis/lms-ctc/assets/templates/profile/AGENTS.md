...
**Scope:** `projects/precis/main/assets/templates/profile/`

Read `projects/precis/main/backend/AGENTS.md` and the root `AGENTS.md` first. New
profile behavior belongs in the active profile app under
`projects/precis/main/backend/apps/pages/profile/` when enabled. This asset folder
