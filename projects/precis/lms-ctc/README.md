...
> **Status:** 🟢 Standalone project — `projects/precis/ctc-research/`
...
and database (`db_ctc_research`) — it does not share Precis/LMS runtime state.
