...
**Path:** `projects/precis/ctc-research/backend/`
...
CTC Research backend only; it does not describe the retired `projects/lms-fusion/`
...
3. `precis/main/assets/templates/` — project asset/template source where configured.
...
CTC Research-specific branding and styles belong under `projects/precis/ctc-research/assets/` or
