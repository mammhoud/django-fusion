...
class MediaGalleryItemBlock(BaseBlock):
    ...
    image = SimpleImageBlock(required=False,
        label=_("Image Content"), template="blocks/media/image.html",
    )

    video = SimpleVideoBlock(required=False,
        label=_("Video Content"), template="blocks/media/video.html",
    )
...
class MediaGalleryBlock(BaseBlock):
    ...
    media_items = blocks.ListBlock(
        MediaGalleryItemBlock(template="blocks/media/gallery_item.html"),
        label=_("Media Items"),
