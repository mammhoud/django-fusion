# Privacy & Terms — wired via i18n_patterns(path("legal/", include("apps.handlers.urls", namespace="legal")))
# in www/urls.py.
...
# ---------------------------------------------------------------------------
urlpatterns = [
    # Privacy & Terms — wired as i18n_patterns(path("legal/", include("apps.handlers.urls", namespace="legal")))
