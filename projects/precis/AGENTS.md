...
**Product:** Precis LMS / learning platform (dispatcher alias: `WEBSITE=lms-fusion`)  
...
```bash
# Project dispatcher (lms-fusion is the compatibility alias)
cd projects
make check WEBSITE=lms-fusion
make test WEBSITE=lms-fusion
make run-dev WEBSITE=lms-fusion
...
- [`../../docs/projects/precis/`](../../docs/projects/precis/) — Product documentation
- [`../landing-fusion/AGENTS.md`](../landing-fusion/AGENTS.md) — Separate product; do not merge
