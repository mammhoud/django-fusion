# Landing-Fusion — Setup & Build Guide
...
Landing-Fusion is the marketing/catalog slice: an **AHA stack** (Astro +
...
- [docs/CATALOG_AND_FUSION.md](../docs/CATALOG_AND_FUSION.md) — product &
  edition comparison, django-fusion dependency surface
- [docs/PROJECT_DESIGN.md](../docs/PROJECT_DESIGN.md) — design decisions
- [`docs/plans/landing-fusion/README.md`](../../../docs/plans/landing-fusion/README.md) — canonical plan
