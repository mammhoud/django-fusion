...
**Path:** `projects/precis/precis-lms/backend/`
...
Precis backend only; it does not describe the retired `projects/precis-lms/`
...
3. `precis/precis-lms/assets/templates/` — project asset/template source where configured.
...
Precis-specific branding and styles belong under `projects/precis/precis-lms/assets/` or
...
# Workspace dispatcher; precis-lms is the compatibility alias for Precis
cd projects
