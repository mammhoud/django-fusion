"""
Events Viewset for precis-lms.com
=====================================
...
Usage::
    ...
    from apps.pages.accounts.viewsets import EventViewset
...
class EventViewset(ModelViewset):
    ...
    Generates:
      GET  /components/events/              → list
      GET  /components/events/add/          → create form
      GET  /components/events/<pk>/detail/  → detail
      GET  /components/events/<pk>/change/  → update form
      GET  /components/events/<pk>/delete/  → delete confirm
    """
