"""
URL configuration for precis-lms.
...
urlpatterns = [
    ...
    path("apis/brand/", landing_api.brand_api, name="landing-brand"),
    path("apis/pricing/", landing_api.pricing_api, name="landing-pricing"),
    path("apis/products/", landing_api.products_api, name="landing-products"),
    path("apis/courses/", landing_api.courses_api, name="landing-courses"),
