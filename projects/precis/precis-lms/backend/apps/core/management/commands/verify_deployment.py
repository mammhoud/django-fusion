...
def _check_traefik_config() -> list[tuple[bool | None, str]]:
    ...
    if "precis-lms.com" in content:
        results.append((True, "Domain configured: precis-lms.com"))
    else:
        results.append((None, "precis-lms.com domain not found in Traefik config"))
...
class Command(BaseCommand):
    ...
    def handle(self, *args: Any, **options: Any) -> None:  # noqa: C901
        ...
        self.stdout.write("Domain    : https://precis-lms.com\n")
