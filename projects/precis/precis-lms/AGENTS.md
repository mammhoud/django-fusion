# Precis LMS — AI Agent Instructions

**Path:** `projects/precis/precis-lms/`  
**Product:** Precis LMS / learning platform (dispatcher alias: `WEBSITE=precis-lms`)  
...
full Precis project surface — backend, frontend, assets, templates, and
...
Precis uses Django/Wagtail server-rendered pages with HTMX fragment swaps and
...
```bash
# Project dispatcher (precis-lms is the compatibility alias)
cd projects
make check WEBSITE=precis-lms
make test WEBSITE=precis-lms
make run-dev WEBSITE=precis-lms
...
# Assets
cd projects/precis/precis-lms/assets
...
- [`../../docs/projects/precis/precis-lms/`](../../docs/projects/precis/precis-lms/) — Product documentation
- [`../precis/precis-landing/AGENTS.md`](../precis/precis-landing/AGENTS.md) — Separate product; do not merge
