...
try: try:
    ...
    pass  # legacy shared module  # noqa: F401, F403
except ImportError:
    pass  # www.ci.services is a legacy shared module, may not be available
 
 if services: pass
except ImportError: pass  # www.ci.services not available
