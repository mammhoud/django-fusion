"""
Tags Snippet ViewSets: Base classes for tag management in Wagtail.

Canonical import: from apps.core.domain.contrib.snippets import BlogTagViewSetBase

Projects should subclass these and inject their tag models.
"""
...
class BlogTagViewSetBase(BaseSnippetViewSet):
    """
    Base class for admin interface for managing Blog Tags.

    Projects should subclass this and set the model:

    class BlogTagViewSet(BlogTagViewSetBase):
        model = BlogTag
    """
...
#@register_snippet
class PersonTagViewSet(BaseSnippetViewSet):
    """
...
#@register_snippet
class PersonTagCategoryViewSet(BaseSnippetViewSet):
    """
    Admin interface for managing Person Tag Categories
    """
    model = PersonTagCategory
    icon = "folder-inverse"
