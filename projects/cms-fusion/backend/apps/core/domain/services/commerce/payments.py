...
Canonical imports::
    from apps.core.domain.services.commerce.payments import PaymentGateway
    from apps.core.domain.services.commerce.payments import StripeGateway
    from apps.core.domain.services.commerce.payments import PayPalGateway
"""
