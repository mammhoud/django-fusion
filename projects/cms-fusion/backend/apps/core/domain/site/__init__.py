...
Canonical imports::
    from apps.core.domain.site.auth import LoginView
...
# Auth views
from apps.core.domain.site.auth import *  # noqa: F401, F403

# Non-auth views
from apps.core.domain.site.views import (  # noqa: F401
    NotificationView,
    PaymentsView,
    SearchView,
    TagsView,
