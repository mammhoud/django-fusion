"""Domain models — discovered by Django via apps.core.domain (label=shared)."""
from ..contrib.models import Corporate  # noqa: F401
from ..handlers.models.manage_company import Department, Organization  # noqa: F401
...
from .users.team import Team, TeamInvitation, TeamMembership  # noqa: F401
