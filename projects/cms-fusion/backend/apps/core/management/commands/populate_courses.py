...
class Command(BaseCommand):
    help = "Populate CTC-Research Courses and Events pages with sample content"
    ...
    def _handle_courses(self, options):
        ...
        lms_fixtures = Path("plugins/lms/fixtures")
    ...
    def _get_or_create_courses_page(self, options):
        ...
        # Find the HomePage to create CoursesPage under it
    ...
    def _get_or_create_event_page(self, options):
        ...
        # Create EventPage under HomePage
        from apps.core.content.models.pages.home import HomePage
        home = HomePage.objects.live().first()
        if home is None:
            self.stderr.write(self.style.ERROR(
