...
Canonical imports::
    from apps.domain.services.commerce.payments import PaymentGateway
    from apps.domain.services.commerce.payments import StripeGateway
    from apps.domain.services.commerce.payments import PayPalGateway
"""
