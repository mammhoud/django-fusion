...
class TestFusionHealthAPI(TestCase):
    """Verify the /apis/health endpoint."""

    def setUp(self):
        self.client = Client()

    def test_health_returns_200(self):
        """GET /apis/health returns HTTP 200."""
...
class TestFusionBrandingAPI(TestCase):
    """Verify the /apis/branding/ endpoint."""

    def setUp(self):
        self.client = Client()

    def test_branding_returns_200(self):
        """GET /apis/branding/ returns HTTP 200."""
...
class TestPagesAPI(TestCase):
    """Verify the /apis/pages/ endpoint."""

    def setUp(self):
        self.client = Client()

    def test_pages_list_returns_200(self):
        """GET /apis/pages/ returns HTTP 200."""
    ...
    def test_page_detail_unknown_slug_returns_404(self):
        """GET /apis/pages/nonexistent/ returns 404 for unknown pages."""
        response = self.client.get("/apis/pages/nonexistent-page-slug/")
...
class TestBlogAPI(TestCase):
    """Verify the /apis/blog/ endpoint."""

    def setUp(self):
        self.client = Client()

    def test_blog_list_returns_200(self):
        """GET /apis/blog/ returns HTTP 200 (empty data when no posts exist)."""
    ...
    def test_blog_categories_returns_200(self):
        """GET /apis/blog/categories returns HTTP 200."""
        response = self.client.get("/apis/blog/categories/")
        assert response.status_code == 200, (
            f"Expected 200, got {response.status_code}"
        )

    def test_blog_tags_returns_200(self):
        """GET /apis/blog/tags returns HTTP 200."""
        response = self.client.get("/apis/blog/tags/")
        assert response.status_code == 200, (
            f"Expected 200, got {response.status_code}"
        )
...
class TestCoursesAPI(TestCase):
    """Verify the /apis/courses/ endpoint."""

    def setUp(self):
        self.client = Client()

    def test_courses_list_returns_200(self):
        """GET /apis/courses/ returns HTTP 200 (empty data when no courses exist)."""
    ...
    def test_courses_filters_returns_200(self):
        """GET /apis/courses/filters returns HTTP 200."""
    ...
    def test_course_detail_unknown_returns_404(self):
        """GET /apis/courses/nonexistent returns 404."""
        response = self.client.get("/apis/courses/nonexistent-course/")
...
class TestProductsAPI(TestCase):
    """Verify the /apis/products/ endpoint."""

    def setUp(self):
        self.client = Client()

    def test_products_list_returns_200(self):
        """GET /apis/products/ returns HTTP 200."""
...
class TestBlogDetailAPI(TestCase):
    """Verify the /apis/blog/<slug>/ detail endpoint."""

    def setUp(self):
        self.client = Client()

    def test_blog_detail_unknown_returns_404(self):
        """GET /apis/blog/nonexistent-post returns 404."""
        response = self.client.get("/apis/blog/nonexistent-post-slug/")
        assert response.status_code == 404, (
            f"Expected 404, got {response.status_code}"
        )
...
class TestAuthStatusAPI(TestCase):
    """Verify the /apis/auth/status endpoint (bolt-only, may 404)."""

    def setUp(self):
        self.client = Client()

    def test_auth_status_returns_response(self):
        """GET /apis/auth/status returns a response (200 or 404 if bolt-only)."""
