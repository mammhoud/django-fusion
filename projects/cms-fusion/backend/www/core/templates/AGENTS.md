...
## Scope
This directory is an app-specific template root for this fusion project. Follow the django-fusion conventions in `libs/django-fusion/AGENTS.md` first, then apply these local notes.
