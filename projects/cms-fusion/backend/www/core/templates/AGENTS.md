...
## Scope
This directory is an app-specific template root for `projects/ctc-research/www/projects/templates`. Follow the shared template rules in `projects/assets/templates/AGENTS.md` first, then apply these local notes.
