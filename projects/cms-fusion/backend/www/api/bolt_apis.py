...
if _has_bolt and bolt is not None:
    ...
    def list_blog_posts(request):
        ...
        try:
            from plugins.blog.models.post import BlogPost
    ...
    def blog_tags(request):
        ...
        try:
            from django.db import models
            from django.db.models import Count
            from plugins.blog.models.tag import BlogTag
    ...
    def list_products(request):
        ...
        try:
            from plugins.products.models.cart import Product
...
def _get_wagtail_page(slug: str):
    ...
    from plugins.pages.content import normalize_slug
