...
- Compiled bundles: `customizer/assets/bundles/cypercloud/`
...
- Source SCSS: `lms/assets/static/styles/`
- Compiled bundles: `lms/assets/bundles/lms/`
- Collectstatic output: `lms/assets/staticfiles/`
...
for debugging media serving issues (see `VResume/www/projects/middleware.py`). Asset and media
