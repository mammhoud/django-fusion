  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <Link href={`/course-details/${enrollment.course}`}
            className="inline-flex items-center gap-2 text-gray-500 hover:text-[rgb(var(--fu-primary))] mb-8 transition-colors">
        ...
        <div className="lg:col-span-3">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                  ...
                  <button
                    ...
                    className={`w-full p-4 rounded-xl border-2 text-left transition-all ${
                      selectedProvider === p.id
                        ? 'border-[rgb(var(--fu-primary))] bg-[rgb(var(--fu-primary))]/5'
                        : 'border-gray-200 hover:border-gray-300 hover:bg-gray-50'
                    }`}
                  >
                    <div className="flex items-center gap-4">
                      <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                        selectedProvider === p.id ? 'bg-[rgb(var(--fu-primary))] text-white' : 'bg-gray-100 text-gray-600'
                      }`}>
                        {p.icon}
                      </div>
                      ...
                      {selectedProvider === p.id && (
                        <HiCheckCircle className="w-5 h-5 text-[rgb(var(--fu-primary))]" />
                      )}
                    </div>
                  </button>
                ))}
            ...
            {step === 'redirecting' && (
              <div className="card p-8 text-center">
                <div className="w-16 h-16 bg-[rgb(var(--fu-primary))]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <HiShieldCheck className="w-8 h-8 text-[rgb(var(--fu-primary))]" />
                </div>
        ...
        <div className="lg:col-span-2">
          <div className="card p-6 lg:sticky lg:top-24">
            ...
            <div className="flex items-start gap-3 pb-4 border-b border-gray-100 mb-4">
              <div className="w-14 h-14 bg-gradient-to-br from-[rgb(var(--fu-primary))] to-[rgb(var(--fu-accent))] rounded-lg flex items-center justify-center flex-shrink-0">
