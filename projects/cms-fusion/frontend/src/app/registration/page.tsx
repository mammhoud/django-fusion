      ...
      <div className="max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="card p-8 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button type="button" onClick={() => setForm({...form, role: 'student'})}
                className={`px-4 py-3 rounded-lg border-2 text-sm font-medium transition-all ${
                  form.role === 'student' ? 'border-[rgb(var(--fu-primary))] bg-[rgb(var(--fu-primary))]/5 text-[rgb(var(--fu-primary-dark))]' : 'border-gray-200 text-gray-600 hover:border-gray-300'
                }`}>Learn as Student</button>
              <button type="button" onClick={() => setForm({...form, role: 'instructor'})}
                className={`px-4 py-3 rounded-lg border-2 text-sm font-medium transition-all ${
                  form.role === 'instructor' ? 'border-[rgb(var(--fu-primary))] bg-[rgb(var(--fu-primary))]/5 text-[rgb(var(--fu-primary-dark))]' : 'border-gray-200 text-gray-600 hover:border-gray-300'
          ...
          <p className="text-center text-sm text-gray-500">
            Already have an account? <Link href="/login" className="text-[rgb(var(--fu-primary))] hover:text-[rgb(var(--fu-primary-dark))] font-medium">Sign in</Link>
          </p>
        </form>
      </div>
    </div>
