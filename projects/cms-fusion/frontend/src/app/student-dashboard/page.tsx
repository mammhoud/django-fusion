  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-10">
        {[
          { href: '/student-dashboard/enrolled-courses', label: 'My Courses', icon: HiAcademicCap, color: 'text-[rgb(var(--fu-primary))]', bg: 'bg-[rgb(var(--fu-primary))]/10' },
          { href: '/student-dashboard/history', label: 'History', icon: HiClock, color: 'text-[rgb(var(--fu-accent))]', bg: 'bg-[rgb(var(--fu-accent))]/10' },
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/student-dashboard/enrolled-courses" className="text-[rgb(var(--fu-primary))] text-sm font-medium hover:text-[rgb(var(--fu-primary-dark))]">
            View All
          </Link>
        </div>
        ...
        {dashLoading ? (
          ...
          <div className="space-y-4">
            {enrollments?.slice(0, 3).map((enrollment, idx) => (
              ...
              >
                <div className="w-24 h-24 bg-gradient-to-br from-[rgb(var(--fu-primary))] to-[rgb(var(--fu-accent))] rounded-lg flex items-center justify-center flex-shrink-0 overflow-hidden">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-3">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        className="bg-[rgb(var(--fu-primary))] h-2 rounded-full transition-all duration-500"
                ...
                {enrollment.is_completed ? (
                  ...
                  <Link href={`/course-details/${enrollment.course}`}
                        className="flex-shrink-0 text-[rgb(var(--fu-primary))] text-sm font-medium hover:text-[rgb(var(--fu-primary-dark))]">
