#!/usr/bin/env python3
"""Minimal standalone CLI for cms-fusion.
...
class SiteCLI:
    """Minimal site controller for cms-fusion."""

    SITE_NAME = "cms-fusion"
    ...
    def configure_django(self) -> None:
        ...
        # Django test discovery to scan cms-fusion/ as a package, leading to
