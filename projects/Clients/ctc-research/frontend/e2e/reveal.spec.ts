 ...
 *
 * Requires a frontend build that contains the fix — the deployed site
 * serves the built artifact, so this test stays red until the frontend
 * container is rebuilt with the corrected CSS.
 */
