...
const siteAliases = {
  ...
  fusionlms: 'precis-lms',
  fusioncms: 'cms-fusion',
  'cms-fusion': 'cms-fusion',
};

const sites = ['lms', 'vresume', 'cypercloud', 'crm', 'precis-lms', 'cms-fusion'];
const siteDirs = {
  'lms': 'lms',
  vresume: 'VResume',
  cypercloud: 'cypercloud',
