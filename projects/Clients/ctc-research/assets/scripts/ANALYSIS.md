...
| File | Used By | Notes |
|------|---------|-------|
| `workspace.mjs` | **Build system** | Main Node.js CLI for asset management. Invoked via `package.json` scripts. Supports building, watching, cleaning, collectstatic, fixture loading, and site management for all sites (lms, vresume, cypercloud, crm, precis-lms, cms-fusion). |
...
| **precis-lms** | ✅ Yes | `npm --prefix assets run build --site precis-lms` |
