...
Merged from apps.pages.accounts.registration.admin.
"""
...
from apps.pages.accounts.models.snippets import AuthEmailTemplate

try:
    from apps.pages.accounts.models.snippets import CSVEmailTest, CSVEmailTestBatch  # noqa: F401
