...
urlpatterns = [
    ...
    path("settings/change-password/", SettingsView.as_view(), name="change_password"),
    path("settings/cancel-subscription/", SettingsView.as_view(), name="cancel_subscription"),
    path("settings/update-plan/", SettingsView.as_view(), name="update_plan"),
    path("settings/delete-account/", SettingsView.as_view(), name="delete_account"),
    path("settings/export-data/", SettingsView.as_view(), name="export_data"),
    path("settings/revoke-sessions/", SettingsView.as_view(), name="revoke_sessions"),
    path("settings/verify-2fa/", SettingsView.as_view(), name="verify_2fa"),
    path("settings/disable-2fa/", SettingsView.as_view(), name="disable_2fa"),
    path("settings/enable-2fa/", SettingsView.as_view(), name="enable_2fa"),
]
