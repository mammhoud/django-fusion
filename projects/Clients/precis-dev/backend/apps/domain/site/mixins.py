...
Application-layer view and model mixins for the domain.site app.

These mixins depend on ``apps.domain.models`` (``Person``,
...
class BaseCartMixin:
    ...
    precis-lms.com: LMS course cart (CourseCartItem model)
...
class BaseDashboardMixin:
    ...
    precis-lms.com: LMS analytics (enrollment stats, learning streaks)
