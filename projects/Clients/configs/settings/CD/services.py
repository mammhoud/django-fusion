...
# -------------------------------------------------------------------
# django-fusion reads FUSION_TASKS from the site settings and creates the
# Redis-backed Dramatiq backend. Periodic jobs use @task(schedule=...) and
# run through django_fusion.tasks.scheduler.
FUSION_TASKS = {
