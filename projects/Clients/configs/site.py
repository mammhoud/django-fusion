...
#
# This file now lives at projects/precis/configs/site.py, so projects/ is two
# parents up (parents[0]=configs, parents[1]=precis, parents[2]=projects).
PROJECT_DIR = Path(__file__).resolve().parents[2]  # repository/projects/
...
def site_dir_for(website: str) -> Path:
    ...
    if runtime_site_dir and requested_site == website:
        ...
        # the host registry path is projects/structa.cloud. Prefer the explicit
