...
class LandingPagesApplication(Application):
    ...
    urlpatterns = [
        ...
        menu_path("about/services/", views.AboutServicesView.as_view(), name="about_services", icon="construction", title="Services"),
        ...
        menu_path("services/benefits/", views.FeaturesPageView.as_view(), name="services_benefits", icon="tune", title="Benefits"),
        # Delivery phases consolidated into /about/services/ — legacy URLs redirect permanently.
        path("services/phases/<slug:slug>/prompts/<slug:prompt_slug>/", RedirectView.as_view(url="/about/services/", permanent=True), name="service_prompt_redirect"),
        path("services/phases/<slug:slug>/", RedirectView.as_view(url="/about/services/", permanent=True), name="service_phase_redirect"),
        ...
        # Benefits moved under Services — legacy URL redirects permanently.
        path("features/", RedirectView.as_view(url="/services/benefits/", permanent=True), name="features_redirect"),
