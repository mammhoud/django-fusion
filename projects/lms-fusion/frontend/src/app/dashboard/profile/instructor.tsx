...
export default function InstructorProfile() {
  ...
  if (profileLoading) return <div className="max-w-2xl mx-auto px-4 py-10"><LoadingSkeleton variant="profile" /><div className="mt-8"><LoadingSkeleton variant="text" count={4} /></div></div>;
  if (isError) return <ErrorState fullPage message="Failed to load profile." />;

  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <h1 className="text-3xl font-bold text-gray-900 mb-8">Profile Settings</h1>
      {saved && <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-xl text-sm mb-4 flex items-center gap-2">Profile saved successfully</div>}
