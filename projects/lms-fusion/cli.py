#!/usr/bin/env python3
"""Minimal standalone CLI for lms-fusion.
...
class SiteCLI:
    """Minimal site controller for lms-fusion."""

    SITE_NAME = "lms-fusion"
    ...
    def configure_django(self) -> None:
        ...
        # Django test discovery to scan lms-fusion/ as a package, leading to
