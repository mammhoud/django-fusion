...
# Import specific views without importing cart.py which depends on ceptor_ai.site
...
# Lazy load ceptor_ai payment views to avoid import conflicts
def _get_payment_urls():
    try:
        from ceptor_ai.site.payments import (
            CartPayPalInitView,
            CartStripeInitView,
            PayPalInitView,
            StripeInitView,
