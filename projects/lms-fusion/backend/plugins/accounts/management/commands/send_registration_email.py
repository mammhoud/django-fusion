...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        from plugins.accounts.emails import send_registration_email
        from plugins.accounts.tokens import registration_token_generator
        from plugins.accounts.views.registration import get_site_url
