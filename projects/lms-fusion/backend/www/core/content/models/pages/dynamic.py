...
Each page type uses StreamField blocks from www.core.content.models.blocks.cms so
...
from www.core.content.models.blocks.cms import PAGE_CONTENT_BLOCKS, DASHBOARD_CONTENT_BLOCKS
