...
class EventSectionBlock(BaseBlock):
    ...
    content_sections = blocks.StreamBlock(
        [
            ...
            (
                "image",
                SimpleImageBlock(label=_("Image"), template="blocks/media/simple_image.html",
                ),
            ),
            (
                "video",
                VideoBlock(label=_("Video"), template="blocks/media/enhanced_video.html",
                ),
            ),
            (
                "embed",
            ...
            (
                "table",
                TableBlock(label=_("Table"), template="blocks/partials/enhanced_table.html",
                    help_text=_("Add structured data like schedules or pricing."),
                ),
            ),
            (
                "speaker",
                EventSpeakerBlock(label=_("Speaker Profile"), template="blocks/pages/event_speaker.html",
                ),
            ),
            (
                "schedule",
                EventScheduleItemBlock(label=_("Schedule Item"), template="blocks/pages/event_schedule_item.html",
                ),
            ),
            (
                "quote",
                BlockQuote(label=_("Quote"), template="blocks/content/block_quote.html",
                ),
            ),
            (
                "html",
                ...
                blocks.StructBlock(
                    [
                        ...
                        (
                            "logos",
                            blocks.ListBlock(
                                SimpleImageBlock(template="blocks/media/simple_image.html"),
