...
Canonical import: from apps.domain.services.commerce.certificate import CertificateServiceBase

Subclass and set ``certificate_model`` to the concrete Certificate model::

    from apps.domain.services.commerce.certificate import CertificateServiceBase
