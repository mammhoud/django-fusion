...
Usage:
    from apps.core.domain.workflows.temporal import (
        TemporalWorker,
        send_email_activity,
...
def __getattr__(name):
    ...
    if name in ("UserOnboardingWorkflow", "BatchProcessingWorkflow"):
        ...
        from apps.core.domain.workflows.temporal import workflows
...
from apps.core.domain.workflows.temporal.activities import (
    EmailPayload,
