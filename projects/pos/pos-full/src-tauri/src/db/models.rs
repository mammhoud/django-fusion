...
#[derive(Debug, Queryable, Selectable, Serialize, Deserialize, Clone)]
#[diesel(table_name = crate::db::schema::crm_companies)]
...
#[derive(Debug, Queryable, Selectable, Serialize, Deserialize, Clone)]
#[diesel(table_name = crate::db::schema::crm_contacts)]
pub struct CrmContact {
    ...
    pub pos_customer_id: Option<i32>,
    pub address: Option<String>,
    pub prefer_contact: Option<String>,
    pub source: Option<String>,
    pub tags: Option<String>,
    pub notes: Option<String>,
...
pub struct UpdateCrmContact {
    ...
    pub pos_customer_id: Option<Option<i32>>,
    pub address: Option<Option<String>>,
    pub prefer_contact: Option<Option<String>>,
    pub source: Option<Option<String>>,
    pub tags: Option<Option<String>>,
    pub notes: Option<Option<String>>,
...
#[derive(Debug, Queryable, Selectable, Serialize, Deserialize, Clone)]
#[diesel(table_name = crate::db::schema::crm_pipelines)]
...
#[derive(Debug, Queryable, Selectable, Serialize, Deserialize, Clone)]
#[diesel(table_name = crate::db::schema::crm_stages)]
pub struct CrmStage {
    pub id: i32,
    pub pipeline_id: i32,
    pub name: String,
...
#[derive(Debug, Queryable, Selectable, Serialize, Deserialize, Clone)]
#[diesel(table_name = crate::db::schema::crm_deals)]
pub struct CrmDeal {
    pub id: i32,
    pub title: String,
    pub description: Option<String>,
    ...
    pub company_id: Option<i32>,
    pub pos_sale_id: Option<i32>,
    pub expected_close_date: Option<NaiveDateTime>,
...
pub struct UpdateCrmDeal {
    ...
    pub contact_id: Option<Option<i32>>,
    pub company_id: Option<Option<i32>>,
    pub pos_sale_id: Option<Option<i32>>,
    pub expected_close_date: Option<Option<NaiveDateTime>>,
    pub closed_date: Option<Option<NaiveDateTime>>,
...
#[derive(Debug, Queryable, Selectable, Serialize, Deserialize, Clone)]
#[diesel(table_name = crate::db::schema::crm_activities)]
...
#[derive(Debug, Queryable, Selectable, Serialize, Deserialize, Clone)]
#[diesel(table_name = crate::db::schema::crm_notes)]
pub struct CrmNote {
    pub id: i32,
    pub content: String,
    pub contact_id: Option<i32>,
...
#[derive(Debug, Queryable, Selectable, Serialize, Deserialize, Clone)]
#[diesel(table_name = crate::db::schema::crm_sync_queue)]
