 ...
 *
 * These types are used by FusionDecoder and any POS component that
 * consumes fusion response payloads.  Extracting them into a standalone
 * file avoids circular imports and keeps the decoder class focused on logic.
 *
 * Usage::
 *
...
/** Fragment pointer as returned by fragment endpoints. */
