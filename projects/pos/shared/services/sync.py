"""
Product catalog and data synchronization between master and child nodes.
...
Used by both pos-solo and pos-full editions via shared import.
"""
...
class ProductSyncEngine:
    ...
    On the master side:
      - Push product catalog, categories, and settings to child nodes
      - Approve/reject incoming sales and reports from children

    On the child side:
      - Receive product catalog from master
      - Push sales, reports, and inventory changes up to master
    """
    ...
    # ── Master → Child: Push product catalog ───────────────────────────
    ...
    # ── Child → Master: Push sales, reports, changes ──────────────────
