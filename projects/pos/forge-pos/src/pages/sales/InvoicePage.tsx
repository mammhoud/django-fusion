...
import Invoice, { PageDesign, InvoiceItem } from '../../components/pos/Invoice';
              ...
              <div>
                ...
                <div ref={comboRef} className="relative">
                  <div className="relative">
                    <span className="icon-[tabler--search] absolute left-2.5 top-1/2 -translate-y-1/2 w-4 h-4 text-base-content/50" />
                    <input
                    ...
                    <button onClick={() => setComboOpen(!comboOpen)} className="absolute right-2 top-1/2 -translate-y-1/2">
                      <span className={`icon-[tabler--chevron-down] w-5 h-5 text-base-content/50 transition-transform ${comboOpen ? 'rotate-180' : ''}`} />
                    </button>
                  </div>
                  {comboOpen && (
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <span className="icon-[tabler--chevron-down] absolute right-2 top-1/2 -translate-y-1/2 text-base-content/50 w-5 h-5 pointer-events-none" />
                  </div>
                </div>
                <div>
