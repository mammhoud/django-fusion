...
interface MenuCategory {
  ...
  color: string;           // Tailwind accent color for header
}
              ...
              {(MENU_ITEMS[cat.id] || []).map((menuItem) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-sm font-semibold text-slate-800 dark:text-white text-center leading-tight">
                      {t(menuItem.label)}
                    </span>
                    <span className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5 text-center leading-tight max-w-[110px]">
