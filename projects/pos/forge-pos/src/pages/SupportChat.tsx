    ...
    >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div>
          ...
          {sidecarOk === false ? (
            <div className="bg-white/70 dark:bg-white/10 backdrop-blur-md border border-white/20 dark:border-white/10 rounded-xl p-6 text-center text-slate-400 text-sm">
            ...
            <div className="space-y-2 max-h-[520px] overflow-y-auto pr-1">
              {ticketList.map(ticket => (
                <motion.div
                  ...
                  className="bg-white/70 dark:bg-white/10 backdrop-blur-md border border-white/20 dark:border-white/10 rounded-xl p-4 cursor-pointer border border-transparent hover:border-teal-300 transition-all"
                >
