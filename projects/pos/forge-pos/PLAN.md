...
- [ ] Resolve CSS + framer-motion double-animation in PageLayout vs PageWrapper
...
- [ ] Notes page / refactor receipt templates
- [ ] useApiMutation optimistic updates

## Execution Order

Phase 1 — Stabilization (P0):
1. Resolve double-animation → decide: keep CSS PageWrapper (remove AnimatePresence from PageLayout) OR keep framer-motion (remove CSS from PageWrapper)
2. Remove unused staggerItem import
