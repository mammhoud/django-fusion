"""
Audit trail model for POS signal events — SignalEvent (Full Edition).
...
class SignalEvent(models.Model):
    ...
    signal_name = models.CharField(
        max_length=50, choices=SIGNAL_NAMES, db_index=True,
    ...
    resource_id = models.CharField(
        ...
        help_text="ID of the resource that changed",
    )
