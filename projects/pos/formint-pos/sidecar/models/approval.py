"""
Moderated approval workflow model — SyncApproval (Full Edition).
...
class SyncApproval(models.Model):
    ...
    ENTITY_TYPES = [
        ("sale", "Sale"), ("product", "Product"), ("config", "Configuration"),
        ("report", "Report"), ("inventory", "Inventory"), ("customer", "Customer"),
        ("employee", "Employee"), ("category", "Category"),
        ("sync", "Sync Batch"), ("other", "Other"),
    ]

    STATUS_CHOICES = [
        ("pending", "Pending Review"), ("approved", "Approved"),
        ("rejected", "Rejected"), ("applied", "Applied to DB"), ("failed", "Apply Failed"),
    ]
    ...
    SYNC_DIRECTION_CHOICES = [
        ("push", "Push from Node"), ("pull", "Pull by Master"), ("sync", "Bidirectional Sync"),
    ]
