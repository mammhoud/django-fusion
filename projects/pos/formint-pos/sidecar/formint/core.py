"""
FormintSite — module-organized POS navigation backed by django-fusion Site/Application.
...
class FormintSite(Site):
    """Top-level site — aggregates module Applications into the full nav tree.
