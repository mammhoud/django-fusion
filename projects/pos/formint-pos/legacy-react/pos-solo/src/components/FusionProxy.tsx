 ...
 * fragment from the sidecar and injects it into the React tree.
 *
 * Adapted from the LMS version — uses the POS ``Skeleton`` component
 * and fetches from the sidecar URL.
 *
 * Usage::
 *
 *     <FusionProxy
 *       fragmentUrl="http://127.0.0.1:8766/fusion/render/dashboard"
