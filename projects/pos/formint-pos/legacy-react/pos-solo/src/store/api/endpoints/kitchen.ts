...
export interface KitchenTicket { id: number; order_id: number; sale_id?: number; table_number: number | null; items: any[]; status: 'pending' | 'preparing' | 'ready' | 'served'; notes: string; created_at: string; updated_at: string; }
