...
const activityIcons: Record<string, { icon: IconType; color: string; bg: string }> = {
  ...
  started: { icon: HiPlay, color: 'text-purple-600', bg: 'bg-purple-100' },
  quiz: { icon: HiStar, color: 'text-yellow-600', bg: 'bg-yellow-100' },
  review: { icon: HiBookOpen, color: 'text-indigo-600', bg: 'bg-indigo-100' },
};
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        {[
          ...
          { label: 'Hours Learned', value: dashboard?.total_hours ?? 0, color: 'text-purple-600', bg: 'bg-purple-100', suffix: 'h' },
        ].map((stat) => (
