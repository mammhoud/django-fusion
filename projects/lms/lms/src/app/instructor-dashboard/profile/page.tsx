  ...
  if (profileLoading) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <div className="mt-8"><LoadingSkeleton variant="text" count={4} /></div>
      </div>
    );
  }

  if (isError) {
    return <ErrorState fullPage message="Failed to load profile." />;
  }
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <form onSubmit={handleSubmit} className="card p-8 space-y-5">
        <div className="flex items-center gap-4 mb-6">
          <div className="w-20 h-20 bg-gradient-to-br from-[rgb(var(--ctc-primary))] to-[rgb(var(--ctc-accent))] rounded-full flex items-center justify-center text-white text-2xl font-bold">
