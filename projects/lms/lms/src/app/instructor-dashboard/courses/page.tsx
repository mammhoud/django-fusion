  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/instructor-dashboard/courses/new" className="btn-primary flex items-center gap-2">
      ...
      {isLoading ? (
                ...
                <tr key={course.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-gradient-to-br card-gradient rounded flex items-center justify-center">
        ...
        <EmptyState icon="courses" title="No courses yet" description="Create your first course to start teaching." actionLabel="Create Course" actionHref="/instructor-dashboard/courses/new" />
      )}
    </div>
  );
}
