        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-4">
            {isLoading ? (
              ...
              <div className="flex items-center gap-3">
                <Link href="/login" className="text-gray-600 hover:text-indigo-600 font-medium">Log In</Link>
        ...
        <div className="md:hidden border-t border-gray-100 bg-white">
          <div className="px-4 py-3 space-y-2">
            ...
            {profile ? (
              ...
              <>
                <Link href="/login" className="block px-3 py-2 text-indigo-600 font-medium" onClick={() => setMobileMenuOpen(false)}>Log In</Link>
                <Link href="/registration" className="block px-3 py-2 text-white bg-indigo-600 rounded-lg text-center font-medium" onClick={() => setMobileMenuOpen(false)}>Sign Up</Link>
              </>
            )}
          </div>
        </div>
