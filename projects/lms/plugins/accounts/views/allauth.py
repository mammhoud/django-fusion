...
These views wrap django-allauth with PageHandler so HTMX fragment rendering
and full-page auth fallbacks share the same behavior.
"""
...
class AllauthLoginView(PageHandler, AllauthBaseLoginView):
    """Wrap allauth LoginView with PageHandler fragment rendering."""

    template_name = "auth/login.html"
    fragment_template = "auth/login.html"
    page_title = "Sign In"
...
class AllauthSignupView(PageHandler, AllauthBaseSignupView):
    """Wrap allauth SignupView with PageHandler fragment rendering."""

    template_name = "auth/register.html"
    fragment_template = "auth/register.html"
    page_title = "Register"
