    ...
    <div className="min-h-screen bg-gray-50">
      <section className="section-hero text-white py-20">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-cyan-100 mb-8">{hero?.intro}</p>
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        <div className="space-y-8">
          {filteredCategories.map((category, catIdx) => (
            <section key={category.title} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        {cta && (
          <div className="mt-12 text-center bg-[rgb(var(--ctc-primary))]/5 rounded-2xl p-8 border border-[rgb(var(--ctc-primary))]/10">
            ...
            <a href={cta.ctas?.[0]?.href || '/contact'} className="btn-primary inline-flex">
              {cta.ctas?.[0]?.label || 'Contact Support'}
            </a>
          </div>
        )}
      </div>
