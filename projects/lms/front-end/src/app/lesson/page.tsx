    ...
    <div className="min-h-screen bg-gray-50 flex">
                ...
                >
                  <span className="flex-shrink-0 w-5 h-5 flex items-center justify-center">
                    {lesson.completed ? (
                      ...
                      <HiPlay className="w-4 h-4 text-indigo-500" />
                    )}
                  </span>
      ...
      <main className="flex-1 min-w-0">
        ...
        <div className="bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-4">
          ...
          <Link href={`/course-details/${courseId}`} className="text-sm text-gray-500 hover:text-indigo-600 transition-colors">
          ...
          <div className="flex items-center gap-2">
            {prevLesson && (
              <Link
                ...
                className="flex items-center gap-1 px-3 py-1.5 text-sm text-gray-600 hover:text-indigo-600 hover:bg-gray-50 rounded-lg transition-colors"
              >
            ...
            {nextLesson && (
              <Link
                ...
                className="flex items-center gap-1 px-3 py-1.5 text-sm bg-indigo-600 text-white hover:bg-indigo-700 rounded-lg transition-colors"
              >
                Next
        ...
        <div className="max-w-4xl mx-auto px-4 py-6">
          ...
          {activeTab === 'notes' && (
            <div>
              <textarea
                className="w-full h-64 p-4 border border-gray-200 rounded-xl resize-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none text-sm"
...
export default function LessonPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><div className="w-12 h-12 border-4 border-indigo-600 border-t-transparent rounded-full animate-spin" /></div>}>
      <LessonContent />
    </Suspense>
  );
}
