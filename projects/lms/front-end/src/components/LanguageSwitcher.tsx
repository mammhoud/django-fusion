...
interface LanguageSwitcherProps {
  ...
  /** Available languages. Falls back to a built-in static list. */
    ...
    <div className={`relative ${className}`} data-component="language-switcher">
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium
                   text-gray-600 hover:text-[rgb(var(--ctc-primary))] hover:bg-[rgb(var(--ctc-primary))]/5
                   transition-colors"
              ...
              <button
                ...
                className={`w-full text-left px-4 py-2 text-sm transition-colors
                  ${lang.code === currentLanguage
                    ? 'bg-[rgb(var(--ctc-primary))]/10 text-[rgb(var(--ctc-primary))] font-medium'
