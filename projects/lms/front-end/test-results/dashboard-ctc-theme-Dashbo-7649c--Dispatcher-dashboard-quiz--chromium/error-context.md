...
- Name: dashboard-ctc-theme.spec.ts >> Dashboard Pages – CTC Teal Theme >> Quiz Dispatcher (/dashboard/quiz)
- Location: tests/e2e/dashboard-ctc-theme.spec.ts:120:9

# Error details

```
Error: Quiz Dispatcher should contain CSS class "btn-primary" (CTC teal theme)
