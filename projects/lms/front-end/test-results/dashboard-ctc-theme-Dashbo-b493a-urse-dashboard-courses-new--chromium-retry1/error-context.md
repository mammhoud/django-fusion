...
- Name: dashboard-ctc-theme.spec.ts >> Dashboard Pages – CTC Teal Theme >> New Course (/dashboard/courses/new)
...
Call log:
  - navigating to "http://localhost:3457/dashboard/courses/new", waiting until "networkidle"
