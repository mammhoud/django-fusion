...
- Name: dashboard-core-flows.spec.ts >> Wishlist – Cards & Interactions >> wishlist shows saved count
- Location: tests/e2e/dashboard-core-flows.spec.ts:391:7
...
Call log:
  ...
  - waiting for locator('text=/\\d+ saved/')
