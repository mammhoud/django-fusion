...
- Name: dashboard-ctc-theme.spec.ts >> Dashboard Pages – CTC Teal Theme >> Student Management (/dashboard/student-manage)
...
Call log:
  - navigating to "http://localhost:3457/dashboard/student-manage", waiting until "networkidle"
