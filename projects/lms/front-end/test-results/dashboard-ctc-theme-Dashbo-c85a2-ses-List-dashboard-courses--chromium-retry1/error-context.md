...
- Name: dashboard-ctc-theme.spec.ts >> Dashboard Pages – CTC Teal Theme >> Courses List (/dashboard/courses)
...
Call log:
  - navigating to "http://localhost:3457/dashboard/courses", waiting until "networkidle"
