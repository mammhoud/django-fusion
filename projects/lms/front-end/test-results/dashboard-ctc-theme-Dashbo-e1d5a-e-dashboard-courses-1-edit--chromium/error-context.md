...
- Name: dashboard-ctc-theme.spec.ts >> Dashboard Pages – CTC Teal Theme >> Edit Course (/dashboard/courses/1/edit)
- Location: tests/e2e/dashboard-ctc-theme.spec.ts:120:9

# Error details

```
Error: Edit Course should contain CSS class "btn-primary" (CTC teal theme)
