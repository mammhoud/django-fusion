...
- Name: dashboard-core-flows.spec.ts >> Wishlist – Cards & Interactions >> each course card has price and level badge
- Location: tests/e2e/dashboard-core-flows.spec.ts:449:7
