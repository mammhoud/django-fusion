...
- Name: dashboard-core-flows.spec.ts >> Reviews – Star Rating & Submit >> empty state shows when no courses to review
- Location: tests/e2e/dashboard-core-flows.spec.ts:353:7

# Error details

```
Error: Should show review cards or empty state
