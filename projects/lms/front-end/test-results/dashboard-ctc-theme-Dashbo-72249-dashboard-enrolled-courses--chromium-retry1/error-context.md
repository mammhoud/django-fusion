...
- Name: dashboard-ctc-theme.spec.ts >> Dashboard Pages – CTC Teal Theme >> Enrolled Courses (/dashboard/enrolled-courses)
...
Call log:
  - navigating to "http://localhost:3457/dashboard/enrolled-courses", waiting until "networkidle"
