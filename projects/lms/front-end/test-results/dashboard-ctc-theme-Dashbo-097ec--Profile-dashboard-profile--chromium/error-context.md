...
- Name: dashboard-ctc-theme.spec.ts >> Dashboard Pages – CTC Teal Theme >> Profile (/dashboard/profile)
- Location: tests/e2e/dashboard-ctc-theme.spec.ts:120:9

# Error details

```
Error: Profile should contain CSS class "btn-primary" (CTC teal theme)
      ...
      - generic [ref=e24]:
        ...
        - main [ref=e39]:
          - generic [ref=e41]:
            ...
            - paragraph [ref=e46]: Please sign in to access this page.
    - contentinfo [ref=e47]:
      - generic [ref=e48]:
        - generic [ref=e49]:
          - generic [ref=e50]:
