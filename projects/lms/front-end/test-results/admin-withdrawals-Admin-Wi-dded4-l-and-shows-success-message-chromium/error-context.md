...
Locator: locator('text=/Withdrawal #10 approved successfully/i')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=/Withdrawal #10 approved successfully/i')
...
- main:
  ...
  - main:
    ...
    - table:
      ...
      - rowgroup:
        - row "#10 Jane Doe $300 PayPal Jul 24, 2026 Pending Approve Reject":
          - cell "#10"
          - cell "Jane Doe"
          - cell "$300"
          - cell "PayPal"
