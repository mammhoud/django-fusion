...
- Name: dashboard-core-flows.spec.ts >> Enrolled Courses – Filters & Search >> search input accepts text
- Location: tests/e2e/dashboard-core-flows.spec.ts:281:7
...
Locator: locator('input[placeholder="Search courses..."]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('input[placeholder="Search courses..."]')
