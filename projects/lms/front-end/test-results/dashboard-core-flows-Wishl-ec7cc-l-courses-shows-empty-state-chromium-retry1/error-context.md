...
- Name: dashboard-core-flows.spec.ts >> Wishlist – Cards & Interactions >> remove all courses shows empty state
- Location: tests/e2e/dashboard-core-flows.spec.ts:426:7
