...
- Name: admin-withdrawals.spec.ts >> Admin Withdrawal Approvals — E2E >> Approve Withdrawal >> shows error when approval fails
- Location: tests/e2e/admin-withdrawals.spec.ts:298:9
...
Locator: locator('text=Withdrawal has already been processed.')
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for locator('text=Withdrawal has already been processed.')
...
- main:
  ...
  - main:
    ...
    - table:
      ...
      - rowgroup:
        - row "#20 Jane Doe $400 PayPal Jul 24, 2026 Pending Approve Reject":
          - cell "#20"
          - cell "Jane Doe"
          - cell "$400"
          - cell "PayPal"
