...
- Name: dashboard-ctc-theme.spec.ts >> Dashboard Pages – CTC Teal Theme >> Withdraw (/dashboard/withdraw)
...
Call log:
  - navigating to "http://localhost:3457/dashboard/withdraw", waiting until "networkidle"
