...
- Name: dashboard-ctc-theme.spec.ts >> Dashboard Pages – CTC Teal Theme >> Announcement (/dashboard/announcement)
...
Call log:
  - navigating to "http://localhost:3457/dashboard/announcement", waiting until "networkidle"
