...
Created by:
    - mammhoud
id: bafyreiajob7vb73bb6ziafclv7wbpnbjjftt7k6jkc3kw5mtf56mavrfly
---
...
- Payroll model missing fields → regular\_hours, overtime\_hours, total\_pay   
 --- 
   
## Related Docs   
- → `features/comparison-matrix.md` — Current feature state   
- → `references/i18n-keys.md` — Translation key changes   
[Changelog — POS Editions](changelog-pos-editions.md)    
