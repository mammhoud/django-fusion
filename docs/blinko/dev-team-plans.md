---
title: Development Team Plans
description: Development team plans, vertical slices, edition chains, and technical references
navigation:
  title: Dev Team Plans
  icon: i-lucide-code
---
...
> **Canonical Source:** `docs/plans/README.md` → Plan Registry
> **Updated:** 2026-08-25
...
**Canonical:** `docs/plans/editions/README.md`
**Owner:** Formint team
**Path:** `projects/formints/`

| Edition | Path | Status | Next Gate |
|---------|------|--------|-----------|
| Community | `formint-community/` | ✅ Complete | — |
| Standard | `formint-standard/` | ✅ Complete | — |
| Professional | `formint-pro/` | 🔄 In Progress | Django backend + sync |
| Cloud | `formint-cloud/` | 📋 Planned | Multi-tenant SaaS + Channels |
| Client | `formint-client/` | ✅ Complete | Vue 3 + Tauri |
