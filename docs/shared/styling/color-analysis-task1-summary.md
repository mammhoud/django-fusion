...
> **Adaptation Note (Task 2.15):** This document was recovered from git history and adapted for the current architecture. File paths have been updated to reflect the current project structure (`structa.cloud/core/`). The color system described applies to the current Wagtail CMS + django-unfold stack. No django-seed references were present — this is a pure styling/design document.
...
### Core Color Variables in `structa.cloud/core/assets/static/styles/colors/_master.scss`
...
The project uses a modular SCSS structure under `structa.cloud/core/assets/static/styles/` with the following directories:
...
1. **`structa.cloud/core/assets/static/styles/layout/_sections.scss`** - Uses theme colors for backgrounds, borders, shadows
2. **`structa.cloud/core/assets/static/styles/layout/_listing.scss`** - Uses theme colors for course cards, buttons, text
3. **`structa.cloud/core/assets/static/styles/components/_parallax.scss`** - References color variables (as noted in comments)
4. **Other component files** under `structa.cloud/core/assets/static/styles/components/` - Likely use color variables for styling
...
### Files to Update:
1. **Primary**: `structa.cloud/core/assets/static/styles/colors/_master.scss` - Core color definitions
2. **Secondary**: Component SCSS files under `structa.cloud/core/assets/static/styles/components/` using color variables
3. **Tertiary**: Theme-specific overrides under `structa.cloud/core/assets/static/styles/themes/` for dark mode
...
1. Update core theme colors in `structa.cloud/core/assets/static/styles/colors/_master.scss`
...
1. **Task 2**: Update color variables in `structa.cloud/core/assets/static/styles/colors/_master.scss`
