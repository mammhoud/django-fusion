...
- ✅ **Analyzed** `structa.cloud/core/assets/static/styles/colors/_master.scss` color variables (1,165 lines)
...
1. `structa.cloud/core/assets/static/styles/layout/_sections.scss` - Section layouts with color variables
2. `structa.cloud/core/assets/static/styles/layout/_listing.scss` - Course cards and listings
3. `structa.cloud/core/assets/static/styles/components/` - All component files reference color variables
4. All base component files under `structa.cloud/core/assets/static/styles/base/` (buttons, forms, typography)
...
1. Update `structa.cloud/core/assets/static/styles/colors/_master.scss` core colors
...
1. `structa.cloud/core/assets/static/styles/colors/_master.scss` - Core color definitions
2. All component SCSS files under `structa.cloud/core/assets/static/styles/components/` referencing color variables
3. Theme configuration files under `structa.cloud/core/assets/static/styles/themes/`
...
1. **Update Core Variables**: Modify `structa.cloud/core/assets/static/styles/colors/_master.scss` with new palette
