...
**Repository URL**: [https://github.com/mammhoud/xellent](https://github.com/mammhoud/xellent)

### 🌿 Branch Strategy
The repository uses a simplified two-branch workflow:
- **[dev](https://github.com/mammhoud/xellent/tree/dev)**: Development and demo environment (active development)
- **[main](https://github.com/mammhoud/xellent/tree/main)**: Production-ready releases (stable code)

### 📦 Variant Branches
Each variant branch represents a filtered version of the platform:
- **[Release/Core](https://github.com/mammhoud/xellent/tree/release/core)**: Framework and infrastructure only (No LMS/Blog).
- **[Release/Blog](https://github.com/mammhoud/xellent/tree/release/blog)**: Content-focused variant (Includes Blog, No LMS).
- **[Release/LMS](https://github.com/mammhoud/xellent/tree/release/lms)**: Dedicated LMS variant (No Blog/Newsletter).
