---
title: Dev
description: POS desktop app development workflow — architecture, dev loop, testing, sidecar, and adding features.
navigation:
  title: Dev
  icon: i-lucide-code
object:
  ...
  id: "guide.dev"
attributes:
  source_path: "guides/04-dev.md"
  canonical_route: "/docs/en/guides/04-dev"
...
links:
  ...
  - label: "POS Backend"
    to: "/projects/pos/backend/rust-backend"
    icon: "i-lucide-database"
---

# 💻 Dev — POS Development Guide
...
- The POS architecture is **three layers**: React (UI) ↔ Rust/Tauri (commands) ↔ Sidecar/Sanic (HTTP/WS + SQLite).
- Diesel schema is auto-generated from migrations — edit migrations, not `schema.rs`.
- Sidecar runs standalone for testing: `python server.py --db ../restaurant.db --port 8765`.
- All env var tests must run with `--test-threads=1` to avoid race conditions.
- When adding a sidecar endpoint, add the TypeScript client in `src/api/`.

---

→ [Back to Guides](README.md) | [Rust Backend](/docs/en/projects/pos/backend/rust-backend) | [TypeScript Frontend](/docs/en/projects/pos/frontend/typescript-frontend) | [Server Docs](/docs/en/projects/pos/server/)
