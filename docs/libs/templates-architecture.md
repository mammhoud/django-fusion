...
1. `projects/<site>/templates/`
2. `projects/<site>/assets/templates/`
3. `projects/assets/templates/`
4. `projects/<site>/www/**/templates/`
5. Installed app templates (Wagtail, allauth, etc.)

## Base templates

### `projects/assets/templates/base.html`
...
### `projects/assets/templates/ui/base_auth.html`

Auth layout that wraps a fragment based on `fragment_name`.

### `projects/assets/templates/ui/base_page.html`
...
1. Create `projects/<site>/templates/myapp/fragment.html`.
2. Create `projects/<site>/templates/myapp/sections/*.html`.
