...
| Script | Purpose |
|--------|---------|
| `applications/scripts/check_markdown_links.py` | Validates every Markdown relative + HTTP link |
| `applications/scripts/check_extras_in_docs.py` | Validates `pyproject.toml` extras match docs |
