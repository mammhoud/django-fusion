...
Created by:
    - mammhoud
id: bafyreihs4gowxbnr5m73axctnuxrprcuftn3fjkcqlrut3b6w3zyxsxuse
---
# Guide — Development Workflow   
**Type:** Guide 📘
T**ags: **#`pos-mini `#`pos-solo `#`pos-full `#`frontend `#`backend
`S**tatus: **Published
C**ategory: **Development   
 --- 
## Project Structure   
```
projects/pos/
...
[Guide — Development Workflow](guide-development-workflow.md)    
