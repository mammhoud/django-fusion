...
1. `core/<site>/templates/components/`
2. `core/<site>/assets/templates/components/`
3. `core/assets/templates/components/`
4. `core/<site>/www/**/templates/`

## Per-page component inventory

> **Notation:** component names use dot notation (e.g., `home.sections.slider`) and map to template paths under `components/` by replacing dots with slashes (e.g., `components/home/sections/slider.html`). Paths shown in the tables are relative to `core/assets/templates/` unless prefixed with a site path.

### Shared CMS pages (`core/assets/templates/`)
...
### VResume pages (`core/VResume/www/pages/templates/`)
