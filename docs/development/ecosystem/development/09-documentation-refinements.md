...
A critical part of the system is the association between system users and their profiles. This is handled via the `Person` model (defined in `django-fusion`).
