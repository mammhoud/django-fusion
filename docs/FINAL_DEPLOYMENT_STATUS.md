...
| LMS-Demo | `lms-demo/assets/static/js/app.js` | ✅ Success | 172 | 11 MB |
...
✅ /root/site/websites/lms-demo/assets/bundles/lms-demo/bundles.json
...
- **web-lms-demo**: LMS Demo Django app
  - Port: 5071
  - Database: db_structa
  - Health Check: HTTP 200 on /health/
