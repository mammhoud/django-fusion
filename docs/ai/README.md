...
| `projects/structa.cloud/AGENTS.md` | LMS site conventions, plugins, components |
...
| `projects/structa.cloud/assets/templates/AGENTS.md` | Precis template organization and resolution order |
| `projects/structa.cloud/assets/templates/components/AGENTS.md` | Precis component inventory |
| `projects/structa.cloud/assets/templates/plugins/AGENTS.md` | Precis plugin template conventions |
