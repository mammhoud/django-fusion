...
| `projects/precis/main/AGENTS.md` | LMS site conventions, plugins, components |
...
| `projects/precis/main/assets/templates/AGENTS.md` | Precis template organization and resolution order |
| `projects/precis/main/assets/templates/components/AGENTS.md` | Precis component inventory |
| `projects/precis/main/assets/templates/plugins/AGENTS.md` | Precis plugin template conventions |
