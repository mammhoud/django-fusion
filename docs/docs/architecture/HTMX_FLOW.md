...
**Implementation**:
```javascript
// In v1/assets/static/js/core/main.js
...
- [Component Development Guide](../development/COMPONENT_GUIDE.md) — How to build components
- [HTMX Integration Guide](../development/HTMX_INTEGRATION.md) — Practical examples
