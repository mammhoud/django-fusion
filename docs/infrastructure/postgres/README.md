...
The actual PostgreSQL configuration is in the `compose/postgres/` directory:
...
- [Dockerfile](compose/postgres/Dockerfile) - Container image
- [Init Scripts](compose/postgres/init.d/) - Initialization
