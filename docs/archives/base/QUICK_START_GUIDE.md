...
docker ps | grep -E 'ctc-research|lms-demo|vresume'
```
...
docker exec lms-demo-website python manage.py loaddata \
  /path/to/essential-data.json
...
media.lms-demo.com        A  <your-server-ip>
...
docker restart lms-demo-website
