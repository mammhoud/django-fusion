...
> **Note:** This is a legacy documentation overview. For the current canonical documentation entrypoint, see [README.md](README.md).

This directory contains comprehensive deployment and operational documentation for Structa Cloud.

## Main Documents

### 1. **deployment/DEPLOYMENT_GUIDE.md** (636 lines)
...
Quick Start?
    ↓
    → Start with deployment/DEPLOYMENT_GUIDE.md § Infrastructure Overview
...
Deploying?
    ↓
    → deployment/DEPLOYMENT_GUIDE.md § Docker Deployment

Configuring SSL?
    ↓
    → deployment/DEPLOYMENT_GUIDE.md § Proxy & SSL Configuration
    → ../INFRASTRUCTURE.md § SSL/TLS Configuration

Running commands?
    ↓
    → deployment/DEPLOYMENT_GUIDE.md § Common Commands
...
- ✅ CLOUDFLARE_OPTIONAL_SETUP.md → deployment/DEPLOYMENT_GUIDE.md § Cloudflare DNS-01
- ✅ DEPLOYMENT_SUMMARY.md → deployment/DEPLOYMENT_GUIDE.md
- ✅ DOCKER_DEPLOYMENT_COMPLETE.md → deployment/DEPLOYMENT_GUIDE.md § Docker Deployment
- ✅ FINAL_DEPLOYMENT_VERIFICATION.md → deployment/DEPLOYMENT_GUIDE.md § Troubleshooting
- ✅ PROXY_INTEGRATION_COMPLETE.md → ../INFRASTRUCTURE.md
- ✅ PROXY_TEST_SUITE.md → deployment/DEPLOYMENT_GUIDE.md § Common Commands
- ✅ TASK3_COMPLETION_SUMMARY.md → Session summary (deleted)
- ✅ TEMPLATE_OSOUL_ANALYSIS.md → deployment/DEPLOYMENT_GUIDE.md § Django Site Setup

---

## Document Structure

### deployment/DEPLOYMENT_GUIDE.md Organization
...
|------|---------|------|------|
| `applications/proxy/traefik/dynamic.yml` | Global Traefik config | Yes | Yes |
| `applications/proxy/traefik/dynamic/*.yml` | Per-site routers | Yes | Yes |
| `applications/proxy/.env` | Cloudflare credentials | No | Yes |
| `applications/proxy/acme/acme.json` | Let's Encrypt store | No | No |
...
### Internal Resources
- `deployment/DEPLOYMENT_GUIDE.md` — Primary operational reference
...
1. **Update relevant section** in deployment/DEPLOYMENT_GUIDE.md or ../INFRASTRUCTURE.md
