...
Unfold admin customizations for ceptor_ai.

Canonical import: from ceptor_ai.contrib.admin_site.unfold import *
"""
...
Wagtail admin customizations for ceptor_ai.

Canonical import: from ceptor_ai.contrib.admin_site.wagtail import *
"""
...
Canonical import: from ceptor_ai.contrib.privacy.middleware import PrivacyConsentMiddleware
"""
...
Cache utilities for ceptor_ai.

Canonical import: from ceptor_ai.contrib.cache.utils import *
"""
...
Django signals for ceptor_ai.

Canonical import: from ceptor_ai.contrib.signals import *
"""
...
Debug tools for ceptor_ai.

Canonical import: from ceptor_ai.contrib.debug_tools import *
"""
...
Email configuration utilities for ceptor_ai.

Canonical import: from ceptor_ai.contrib.email_config import *
"""
...
Orchestrator CLI for ceptor_ai.

Canonical import: from ceptor_ai.workflows.orchestrator import *
"""
...
''')
    ...
    def task_3_17_boundary_check(self) -> bool:
        ...
        # Check for project-specific imports in ceptor_ai
        project_patterns = [
            r"from apps\.",
            r"import apps\.",
            r"from ctc-research",
        ...
        if violations:
            ...
            self.log(f"✓ No project-specific imports found in ceptor_ai")
