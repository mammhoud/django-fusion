...
**Primary Files:**
1. `structa.cloud/core/assets/static/styles/colors/_master.scss` - Core color variables
2. `structa.cloud/core/assets/static/styles/base/_buttons.scss` - Button components
3. `structa.cloud/core/assets/static/styles/base/_forms.scss` - Form elements
4. `structa.cloud/core/assets/static/styles/components/` - Component-specific styles
5. Theme files under `structa.cloud/core/assets/static/styles/themes/` for light/dark modes
