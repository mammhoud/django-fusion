...
Based on analysis of `structa.cloud/core/assets/static/styles/colors/_master.scss`
...
1. `structa.cloud/core/assets/static/styles/layout/_sections.scss` - Layout sections with shadow and gradient variables
2. `structa.cloud/core/assets/static/styles/layout/_listing.scss` - Course cards and featured courses
3. Various component files under `structa.cloud/core/assets/static/styles/components/` that use color variables
...
This analysis provides the foundation for the color system update to the new cohesive palette.
