...
3. Check [QUICK_START.md](../deployment/QUICK_START.md) for deployment
...
### To Deploy
1. Run [QUICK_START.md](../deployment/QUICK_START.md) procedures
2. Verify with [TEST_PLAN.md](../deployment/TEST_PLAN.md)
3. Follow [MANUAL_GUIDE.md](../deployment/MANUAL_GUIDE.md) if issues occur
