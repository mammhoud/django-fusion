...
This guide covers the maintained reusable packages in `libs/`. Both are
...
|---|---|---|---|
| `django-fusion` | `libs/django-fusion/` | Django/Wagtail components, routing, forms/tables, viewsets, middleware, health checks | AI provider calls, site models, credentials |
| `ceptor-ai` | `libs/ceptor-ai/` | AI helpers, orchestration, CLI, and optional MCP metadata | Django/Wagtail/Celery/database imports in its standalone surface |
...
code. The canonical paths are always under `libs/`.
...
- `libs/django-fusion/docs/01-getting-started.md`
- `libs/django-fusion/docs/04-component-tag.md`
- `libs/django-fusion/docs/05-routing.md`
- `libs/django-fusion/docs/09-health.md`
- `libs/django-fusion/docs/10-wagtail-integration.md`
...
> `libs/django-fusion` or `libs/ceptor-ai`, and inspect the package
