...
```
✅ Bundle files exist (ctc-research, lms, VResume)
...
Domains Covered:
  ...
  ✅ media.ctc-research.com, media.lms.com, media.vresume.structa.cloud, media.structa.cloud

Backup System:
  ✅ Script: /root/site/websites/compose/traefik/cert-backup.sh
  ✅ Commands: backup, restore, list, cleanup, status
  ✅ Storage: /root/site/websites/compose/traefik/certs/
```
...
- [ ] Deploy websites: `docker compose up -d ctc-research-website lms-website vresume-website`
...
docker compose up -d lms-website      # Just LMS
