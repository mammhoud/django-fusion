...
```
Directory: compose/traefik/certs/20260602_180649_certs/
Size: 24K
Contents:
  - acme.json (13K)
...
- `media.lms.com` → Shared media server
...
- [ ] Deploy all three websites (ctc-research, lms, vresume)
...
**Primary Backup**:
```
/root/site/websites/compose/traefik/certs/production-certs-20260602-180702.tar.gz
```
