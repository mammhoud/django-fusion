...
|------|----------|------|-------|--------------|
| ACME JSON | certs/20260602_180649_certs/ | 24K | 1 | 18:06:49 UTC |
| Compressed Archive | certs/*.tar.gz | 16K | 2 | 18:07:15 UTC |
| Total Backup Size | certs/ | ~40K | 3+ | Today |
...
**Immediate (This Week)**:
1. [ ] Deploy all three websites (ctc-research, lms, vresume)
