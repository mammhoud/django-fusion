> **Archive status:** Read-only historical copy preserved during the 2026-08-11 project closeout.

> **Canonical replacement:** See `../../../cms-fusion/migration-plan.md` for the superseded status and current project boundary.
