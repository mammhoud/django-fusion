...
- `lms/assets/templates/base.html`
...
- **Sites Integrated:** 3 sites (ctc-research, lms, VResume)
...
git checkout lms/assets/templates/base.html
...
Modified:
  ...
  - lms/assets/templates/base.html (JS includes added)
