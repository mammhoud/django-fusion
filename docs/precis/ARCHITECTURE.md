...
- **Per-project isolation.** Templates, assets, and static files are scoped to
  `projects/precis/`, never shared with landing-fusion or formints.
...
project-specific config at `projects/precis/webpack/precis.config.js`.
...
```
1. projects/precis/backend/templates/          # Site-root shells, errors
2. projects/precis/backend/apps/*/templates/   # App-owned templates
3. projects/precis/assets/templates/           # Shared asset templates
...
- [`projects/precis/backend/AGENTS.md`](/projects/precis/backend/AGENTS.md) — Backend agent instructions
- [`projects/precis/README.md`](/projects/precis/README.md) — Project README (note: stack line references Next.js; source is Astro)
