#!/usr/bin/env python3
"""
Entry point for ctc-research.com website CLI.
Usage:
  python ctc-research.com/__main__.py check
  python ctc-research.com/__main__.py manage migrate
  python ctc-research.com/__main__.py shell
"""
import os
import subprocess
import sys
