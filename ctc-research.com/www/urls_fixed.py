...
try:
    from django_grep.contrib.debug_tools.common_urls import (
        configure_common_urls,
    )
except Exception:
...
if (
    wagtail_urls
    and wagtailadmin_urls
    and wagtaildocs_urls
):
    urlpatterns += [
...
if settings.DEBUG:
    try:
        from django_grep.contrib.debug_tools.dev_urls import (
            configure_dev_urls,
        )
