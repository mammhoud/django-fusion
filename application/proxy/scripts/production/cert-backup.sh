...
Examples:
  ...
  $0 restore /root/site/websites/application/proxy/data/backups/20260602_121530_certs
...
Automated Backup Integration:
  ...
  0 2 * * * cd /root/site/websites/application/proxy/scripts && ./cert-backup.sh backup >> /var/log/traefik-backup.log 2>&1
