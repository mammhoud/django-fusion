...
Usage:
    python3 application/scripts/dev/check_fixture_pages.py        # Check both CMS and LMS
    python3 application/scripts/dev/check_fixture_pages.py --cms  # CMS only
    python3 application/scripts/dev/check_fixture_pages.py --lms  # LMS only
"""
