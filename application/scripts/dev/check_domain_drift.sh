...
#
# Usage:
#   ./application/scripts/dev/check_domain_drift.sh          # check both
#   ./application/scripts/dev/check_domain_drift.sh --quiet  # silent on success
#   ./application/scripts/dev/check_domain_drift.sh --fix    # show diff for manual fix
# =============================================================================
set -euo pipefail
