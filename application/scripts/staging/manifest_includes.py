...
::
    ...
    python3 application/scripts/manifest_includes.py
    python3 application/scripts/manifest_includes.py projects/assets/templates/
    python3 application/scripts/manifest_includes.py --json | jq '.buckets'
