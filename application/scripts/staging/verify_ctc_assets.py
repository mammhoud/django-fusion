...
Usage:
    python application/scripts/verify_ctc_assets.py
    python application/scripts/verify_ctc_assets.py --strict
    python application/scripts/verify_ctc_assets.py --site precis-ctc
...
APPLICATIONS_ROOT = REPOSITORY_ROOT / "application"
