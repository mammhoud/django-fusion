...
from django_rseal.pipelines.managers import BaseManager
...
class EnrollmentsManager(BaseManager):
    ...
    def get_enrollment_analytics(self, user):
        ...
        # Safe division — avoids DB-level division by zero
        total = analytics['total_enrollments'] or 0
        completed = analytics['completed_enrollments'] or 0
        analytics['completion_rate'] = (completed * 100.0 / total) if total > 0 else 0.0
